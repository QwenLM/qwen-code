...
describe('release workflow', () => {
  ...
  it('bounds shared-pool jobs and skips redundant remote npm caches', () => {
    expect(
      ...
      // pinned by its own test above. Run 33713579913: a passing shard's
      // test step took 41m32s of the ~42m a 45-minute cap left it, and
      // attempt 3 was cancelled with both shards still live. 90 clears
      // that plus --retry=2's re-runs.
      workspace_tests:
