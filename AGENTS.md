...
- **Comments**: Add a concise function-level comment for every newly added
  function. Explain its purpose and any non-obvious lifecycle or security
  boundary without restating the implementation; don't delete existing comments
  as cleanup.
