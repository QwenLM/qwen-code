...
function markReviewed(sha) {
  writeFileSync(join(statusDir, sha), '');
}
...
before(() => {
  ...
  writeFileSync(
    ...
    [
      ...
      '  printf \'{"state":"success","statuses":[{"context":"qwen-review/reviewed","state":"success"},{"context":"ci/other","state":"failure"}]}\'',
      'else',
