...
test('rejects candidate changes to trusted verification inputs', () => {
  withRepository((workspace) => {
    ...
    for (const file of [
      ...
      'packages/cli/src/commands/review/lib/test-utils.ts',
      'packages/core/src/services/session-writer-lease.test-helper.ts',
      'packages/cli/src/serve/cdp-tunnel/acceptance/acceptance-helpers.mjs',
      'packages/cli/src/serve/cdp-tunnel/acceptance/fixture-server.mjs',
