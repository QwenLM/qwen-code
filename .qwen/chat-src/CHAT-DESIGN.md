...
## 6. 替代方案对比 (Alternatives Considered)
...
| -------------- | ------ | ---------- |
| chat.md        | ~1100  | ~350       |
| chat-save.md   | ~2000  | ~650       |
| chat-list.md   | ~120   | ~40        |
| chat-resume.md | ~1050  | ~350       |
| chat-delete.md | ~1100  | ~350       |

---

## 8. 测试记录

### 8.1 单元测试（来自原始 PR #3105）

| 测试文件                                           | 测试数 | 状态        |
| -------------------------------------------------- | ------ | ----------- |
| `packages/core/src/services/chatIndex.test.ts`     | 12     | ✅ 全部通过 |
| `packages/cli/src/ui/commands/chatCommand.test.ts` | 21     | ✅ 全部通过 |
