...
// where the bits are real. Shared inside qwen-live by the monitor debug
// store ('owner-only') and live discovery ('exact-0700', or 'none' for a
// non-private base); packages/cli keeps its own copies of this gate because
