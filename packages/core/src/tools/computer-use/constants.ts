 ...
 *
 * To bump: update this and the Qwen Live Host pin in
 * `packages/desktop/apps/live-host/src/shared/cua-driver-version.ts`, re-run
 * `scripts/sync-computer-use-schemas.ts` against the new binary, sync the new assets to OSS via
