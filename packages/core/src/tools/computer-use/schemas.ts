 ...
 *
 * Pinned to: @qwen-code/open-computer-use@0.2.2
 ...
 * The 0.2.0 → 0.2.2 changes (notarization, the window-free
 * `permission-status` CLI command) do not alter the MCP tool surface, so
 * these schemas are unchanged across all three releases.
 *
