...
const TEAM_AGENT_READ_ONLY_PROPERTY = {
  ...
  description:
    ...
    'named teammate in an active team. Mutually exclusive with ' +
    'plan_mode_required.',
};
