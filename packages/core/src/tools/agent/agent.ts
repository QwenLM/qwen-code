...
// TODO: Re-enable when retry mechanism is wired into upstream execution path
...
// TODO: Re-enable when getCacheSafeParams is wired into upstream execution path
...
class AgentToolInvocation extends BaseToolInvocation<AgentParams, ToolResult> {
  ...
  async execute(
    ...
    try {
      ...
      if (isFork) {
        ...
        // TODO: getCacheSafeParams was used in the fork's old execution path
        // to share DashScope prompt cache with fork subagents. The upstream
        // architecture (createForkSubagent) handles this differently via
        // generationConfig inheritance. Evaluate whether to port this
        // optimization into the upstream path.
  ...
  // TODO: Re-enable retry mechanism by wiring into upstream's runSubagentWithHooks.
  // This method implements exponential backoff for InvalidStreamError but is not
  // currently called in the upstream execution architecture. Consider porting to
  // runSubagentWithHooks or contributing upstream.
  /*
