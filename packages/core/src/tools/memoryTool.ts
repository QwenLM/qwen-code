...
- \`scope\` (string, optional): Where to save the memory:
  - "global": Saves to user-level ~/.proto/QWEN.md (shared across all projects)
  - "project": Saves to current project's QWEN.md (project-specific)
  - If not specified, the tool will ask the user where they want to save the memory.
`;

export const QWEN_CONFIG_DIR = '.proto';
export const DEFAULT_CONTEXT_FILENAME = 'PROTO.md';
export const AGENT_CONTEXT_FILENAME = 'AGENTS.md';
export const MEMORY_SECTION_HEADER = '## Proto Added Memories';

// Context files to load, in priority order. PROTO.md is primary, with
// QWEN.md and CLAUDE.md as fallbacks for compatibility with existing projects.
