...
export const DEFAULT_DIFF_OPTIONS: Diff.StructuredPatchOptionsNonabortable = {
  context: 3,
  ignoreWhitespace: true,
};

export const DEFAULT_CREATE_PATCH_OPTIONS: Diff.CreatePatchOptionsNonabortable =
  {
    context: 3,
    ignoreWhitespace: true,
  };
