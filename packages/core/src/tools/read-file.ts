...
> {
  ...
  constructor(private config: Config) {
    super(
      ...
      `Reads and returns the content of a specified file. If the file is large, the content will be truncated. The tool's response will clearly indicate if truncation has occurred and will provide details on how to read more of the file using the 'offset' and 'limit' parameters. Handles text, images (PNG, JPG, GIF, WEBP, SVG, BMP), and PDF files (extracts text content). For text files, it can read specific line ranges.`,
      Kind.Read,
      {
        properties: {
          file_path: {
