          ...
          if (this.params.run_in_background) {
            ...
            void (async () => {
              try {
                ...
                debugLogger.error(
                  `[Agent] Background agent failed: ${errorMsg}`,
                );
            ...
            // Update display and return early — don't proceed to foreground execute
