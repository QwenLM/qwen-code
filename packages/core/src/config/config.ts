...
export class Config {
  ...
  private readonly fileReadCache = new FileReadCache();
   ...
   * on files. One instance per Config, which means each subagent that
   * creates its own Config inherently starts with an empty cache.
   */
