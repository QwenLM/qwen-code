...
export class Config {
  ...
  private initializeGoalRuntime(
    ...
    const runtime = createGoalRuntime({
      ...
      // No checkpoint verifier. The checkpoint's only reader was the
      // evidence catalog that update_goal cited from, and a checkpoint that
      // stalled three times stopped the Goal; with no verifier wired the
      // runtime creates no checkpoint attempts at all.
