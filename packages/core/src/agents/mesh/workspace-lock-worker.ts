...
import { allocateRunSequence } from './mesh-store.js';

const runtimeDir = process.env['MESH_LOCK_RUNTIME_DIR'];
const projectRoot = process.env['MESH_LOCK_PROJECT_ROOT'];
const count = Number(process.env['MESH_LOCK_COUNT']);
