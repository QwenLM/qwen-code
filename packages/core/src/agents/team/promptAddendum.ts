...
export function buildTeammatePromptAddendum(
  ...
  if (options.planModeRequired) {
    return [
      ...
      '',
      '7. REPORT RESULTS: Return a concise final answer with findings, evidence, uncertainty, and recommended next action. The runtime forwards it to the leader automatically. This ends your turn.',
      '',
      '8. REPEAT: Check task_list again for more pending tasks.',
