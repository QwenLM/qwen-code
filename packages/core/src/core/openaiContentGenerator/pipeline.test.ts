...
describe('ContentGenerationPipeline', () => {
  ...
  describe('execute', () => {
    ...
    it.each([
      ...
      {
        name: 'remove required tool selection for Standard DeepSeek V4 reasoning effort',
        baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1',
      ...
      {
        name: 'remove required tool selection for Token Plan DeepSeek V4 reasoning effort',
        baseUrl:
          'https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1',
      ...
      {
        name: 'remove required tool selection for Token Plan toggle-only kimi-k2.5',
        baseUrl:
          'https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1',
        model: 'kimi-k2.5',
        extraBody: { enable_thinking: true },
      ...
      {
        name: 'remove required tool selection for Token Plan toggle-only kimi-k2.6',
        baseUrl:
          'https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1',
        model: 'kimi-k2.6',
        extraBody: { enable_thinking: true },
      ...
      {
        name: 'preserve required tool selection when a registered DeepSeek model disables thinking',
        baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1',
        model: 'deepseek-v4-pro',
        extraBody: { enable_thinking: true },
        thinkingMandatory: undefined,
      ...
      {
        name: 'preserve required tool selection when a registered Kimi model disables thinking',
        baseUrl:
          'https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1',
        model: 'kimi-k2.6',
        extraBody: { enable_thinking: true },
