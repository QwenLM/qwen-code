import { isDashScopeProvider } from './dashscope-origin.js';
...
export function withoutNullishThinkingKnobs(
  layer: Record<string, unknown> | undefined,
...
export { DASHSCOPE_REGIONAL_HOSTS } from './dashscope-origin.js';
...
export class DashScopeOpenAICompatibleProvider extends DefaultOpenAICompatibleProvider {
  ...
  static isDashScopeProvider = isDashScopeProvider;
