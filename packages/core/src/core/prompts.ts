...
- **File Modification Safety:** When modifying existing files, prefer using the '${EditTool.Name}' tool over '${WriteFileTool.Name}'. The '${EditTool.Name}' tool is safer as it requires you to provide the exact text to replace, ensuring you don't accidentally overwrite the entire file. Only use '${WriteFileTool.Name}' when you intend to completely overwrite a file or create a new one. Using '${WriteFileTool.Name}' on an existing file will replace its entire content, which could lead to data loss if not used carefully.
...
- **File Modification Best Practices:** When editing existing files, always prefer the '${EditTool.Name}' tool over '${WriteFileTool.Name}'. The '${EditTool.Name}' tool is safer because it requires you to specify exactly what text to replace, preventing accidental data loss. Only use '${WriteFileTool.Name}' when you want to create a new file or completely overwrite an existing file's contents.
