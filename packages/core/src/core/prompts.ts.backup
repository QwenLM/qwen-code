...
- **RAG Search:** Use the 'rag_search' tool to search through local knowledge bases, code collections, and documentation. This provides immediate access to relevant information without external dependencies. Use it when you need to find specific code examples, documentation, or project-specific context.
- **Text-to-Speech:** Use the 'text_to_speech' tool to provide audio feedback, announce progress updates, or read results aloud. This enhances accessibility and provides hands-free updates during long operations. Different voices are available for different contexts and personalities.
