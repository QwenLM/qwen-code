...
// Node on Windows derives the timezone from the OS at process start and
// ignores a runtime process.env.TZ assignment, so the America/New_York
// transitions this suite simulates cannot be reproduced there.
describe.skipIf(process.platform === 'win32')(
  'nextFireTime across DST transitions',
  () => {
