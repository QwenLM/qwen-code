...
describe('classifyShellCommandSafety', () => {
  it.each([
    ...
    'rg -- -z file',
    'grep -eQ file',
    'grep -e --save-config file',
    'grep -e -Q file',
    'grep --regexp --filter file',
    'sort -- -roout input',
    'sort -- --output=out',
    "sed -- 's/a/b/' input",
    "sed 's/a/*/' file",
  ...
  it.each([
    ...
    'grep --save-config=/tmp/ugrep.conf needle file',
    'grep --save-config needle file',
    'grep --save-config= conf.txt needle file',
    'echo $(rm target)',
    'FOO=$(rm target)',
    'cat <(rm target)',
    'cat < <(rm target)',
  ...
  it.each([
    ...
    'grep --config=/tmp/ugrep.conf needle file',
    'grep -ZQ needle file',
    'grep -e -- --config=/tmp/ugrep.conf needle file',
    'grep -e -- --filter=cat needle file',
    'grep --regexp -- --filter=cat needle file',
    'grep --colors --filter=cat needle file',
    "grep --filter='txt:helper %' needle file.txt",
    'grep --pager=helper needle file',
    'grep --view=helper -Q needle file',
    'grep -nQ needle file',
    'grep --query needle file',
    'grep -@ needle file',
    'grep --all needle file',
    'grep --no-ignore-files needle file',
    'rg --no-ignore-files needle file',
    'grep ---/tmp/ugrep.conf needle file',
