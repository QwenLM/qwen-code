...
describe('UpdateGoalTool', () => {
  ...
  it('exposes the current-turn evidence contract', () => {
    ...
    expect(tool.description).toContain(
      'visible output and tool results of this Goal turn',
    );
    expect(tool.description).toContain(
      'run the checks that prove every objective condition in this turn',
    );
