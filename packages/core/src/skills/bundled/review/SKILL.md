...
**Why this is a command and not a paragraph.** It was a paragraph, and the paragraph was skipped. A run once printed an Approve it had composed itself, from prose, on a review whose gate had just refused (measured; DESIGN.md — The self-composed Approve). There is now one place a verdict exists. Skipping the command does not get you a different one; it gets you none.
