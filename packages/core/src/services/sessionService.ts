...
export class SessionService {
  ...
  private readSessionGoalObjectiveFromFile(
    ...
    const objective = readLastJsonStringFieldSync(
      filePath,
      'objective',
      '"subtype":"goal_state"',
      tailBuffer,
  ...
  async listSessions(
    ...
    for (const file of files) {
      ...
      signal?.throwIfAborted();
      const goalObjective =
        prompt || titleInfo.title
          ? undefined
          : (this.readSessionGoalObjectiveFromFile(filePath, tailBuffer) ??
  ...
  async getSessionListItem(
    ...
    return {
      ...
      goalObjective:
        prompt || titleInfo.title
          ? undefined
          : (this.readSessionGoalObjectiveFromFile(filePath) ??
            this.extractGoalObjectiveFromRecords(records)),
      titleSource: titleInfo.source,
      ...(source.parentSessionId
        ? { parentSessionId: source.parentSessionId }
