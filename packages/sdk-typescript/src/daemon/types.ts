 ...
 * may key behavior off. The evidence kinds mark a window a plain resume cannot
 * simply re-enter; `token_budget` marks a spent autonomous-spend authorization
 * that a resume re-arms.
 */
