  ...
  return [
    {
      ...
      description: t('Checked in at .proto/settings.json'),
      value: SettingScope.Workspace,
      key: 'project',
    },
    {
      label: t('User settings'),
      description: t('Saved in at ~/.proto/settings.json'),
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("proto won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('proto will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('proto is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
