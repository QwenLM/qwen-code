 ...
 * evaluation. `opentui-entry.tsx` imports it as its first import for exactly
 * that reason; keep this file free of `@opentui/*` imports.
 */
...
// Side effect: configure the asset root as early as possible. opentui-entry
