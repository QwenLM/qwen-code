...
export default {
  ...
  // Commands - Skills
  // ============================================================================
  'Manage and inspect skills.': 'Управление и проверка навыков.',
  'Manage existing skills (view, edit, delete).':
    'Управление существующими навыками (просмотр, редактирование, удаление).',
  'Create a new skill with guided setup.':
    'Создание нового навыка с помощью пошагового мастера.',

  // ============================================================================
  // Skills - Management Dialog
  // ============================================================================
  'skills.title': 'Навыки',
  'skills.chooseAction': 'Выберите действие',
  'skills.edit': 'Редактировать {{name}}',
  'skills.delete': 'Удалить {{name}}',
  'skills.unknownStep': 'Неизвестный шаг',
  'skills.escToClose': 'Esc для закрытия',
  'skills.nav.select': 'Enter для выбора, ↑↓ для навигации, Esc для закрытия',
  'skills.nav.back': 'Esc для возврата',
  'skills.nav.confirm': 'Enter для подтверждения, Esc для отмены',
  'skills.nav.selectAndBack':
    'Enter для выбора, ↑↓ для навигации, Esc для возврата',
  'skills.error.invalidStep': 'Неверный шаг: {{step}}',
  'skills.noSkills': 'Навыки не найдены.',
  'skills.createPrompt':
    'Используйте /skill create для создания вашего первого навыка.',
  'skills.overridden': '(переопределено навыком уровня проекта)',
  'skills.projectLevel': 'Уровень проекта ({{path}})',
  'skills.globalLevel': 'Глобальный уровень ({{path}})',
  'skills.builtin': 'Встроенные навыки',
  'skills.usingCount': 'Используется: {{count}} навыков',
  'skills.view': 'Просмотреть навык',
  'skills.editAction': 'Редактировать навык',
  'skills.deleteAction': 'Удалить навык',
  'skills.noSkillSelected': 'Навык не выбран',
  'skills.deleteConfirmation':
    'Вы уверены, что хотите удалить навык "{{name}}"?',
  'skills.openInEditor': 'Открыть SKILL.md в редакторе',
  'skills.error.launchEditor': 'Не удалось запустить редактор: {{error}}',
  'skills.error.generic': '❌ Ошибка:',
  'skills.filePath': 'Путь к файлу: ',
  'skills.allowedTools': 'Разрешенные инструменты: ',
  'skills.instructions': 'Инструкции:',
  'skills.path': 'Путь: ',
  'skills.scope': 'Область: ',

  // ============================================================================
  // Skills - Creation Wizard
  // ============================================================================
  'skills.create.success': '✅ Навык успешно создан!',
  'skills.create.saved': 'Навык "{{name}}" сохранен на уровне {{level}}.',
  'skills.create.projectLevel': 'Уровень проекта (.qwen/skills/)',
  'skills.create.userLevel': 'Уровень пользователя (~/.qwen/skills/)',
  'skills.create.error.save': '❌ Ошибка сохранения навыка:',
  'skills.create.warnings': 'Предупреждения:',
  'skills.create.warn.overwrite':
    'Имя "{{name}}" уже существует на уровне {{level}} - существующий навык будет перезаписан',
  'skills.create.warn.userPrecedence':
    'Имя "{{name}}" существует на уровне пользователя - уровень проекта будет иметь приоритет',
  'skills.create.warn.projectPrecedence':
    'Имя "{{name}}" существует на уровне проекта - существующий навык будет иметь приоритет',
  'skills.create.warn.descLength': 'Описание превышает {{length}} символов',
  'skills.create.error.saveAndEdit':
    'Не удалось сохранить и отредактировать навык: {{error}}',
  'skills.create.error.config': 'Конфигурация недоступна',
  'skills.create.error.projectRoot': 'Корень проекта недоступен',
  'skills.create.error.skillManager': 'Менеджер навыков недоступен',
  'skills.create.step.location': 'Шаг {{n}}: Выберите расположение',
  'skills.create.step.name': 'Шаг {{n}}: Введите имя навыка',
  'skills.create.step.description': 'Шаг {{n}}: Введите описание',
  'skills.create.step.instructions': 'Шаг {{n}}: Введите инструкции',
  'skills.create.step.color': 'Шаг {{n}}: Выберите цвет фона',
  'skills.create.step.confirm': 'Шаг {{n}}: Подтвердите и сохраните',
  'skills.create.step.method': 'Шаг {{n}}: Выберите метод генерации',
  'skills.create.nav.save':
    'Нажмите Enter для сохранения, e для сохранения и редактирования, Esc для возврата',
  'skills.create.nav.continue':
    'Нажмите Enter для продолжения, {{navigation}}Esc для {{action}}',
  'skills.create.cancel': 'отмены',
  'skills.create.goBack': 'возврата',
  'skills.create.nav.arrows': '↑↓ для навигации, ',
  'skills.create.prompt.name':
    'Введите четкое, уникальное имя для этого навыка.',
  'skills.create.placeholder.name': 'например, my-awesome-skill',
  'skills.create.error.nameEmpty': 'Имя не может быть пустым.',
  'skills.create.error.nameFormat':
    'Имя должно содержать только строчные буквы, цифры и дефисы.',
  'skills.create.error.nameLength': 'Имя не может превышать 64 символа.',
  'skills.create.error.nameReserved':
    'Имя не может содержать "anthropic", "claude" или "qwen".',
  'skills.create.error.generator: {{error}}':
    'Не удалось сгенерировать навык: {{error}}',
  'skills.create.generating': 'Генерация конфигурации навыка...',
  'skills.create.prompt.description':
    'Опишите, когда и как следует использовать этот навык.',
  'skills.create.placeholder.description':
    'например, Этот навык помогает создать новый компонент.',
  'skills.create.error.descriptionEmpty': 'Описание не может быть пустым.',
  'skills.create.error.descriptionLength':
    'Описание не может превышать 1024 символа.',
  'skills.create.error.descriptionXml': 'Описание не может содержать теги XML.',
  'skills.create.prompt.instructions':
    'Предоставьте подробные инструкции о том, когда и как использовать этот навык.\n\n💡 Лучшие практики:\n• Краткость: Цель ~5000 токенов. Предполагайте, что модель умна.\n• Высокая свобода (Анализ): Используйте описания на естественном языке.\n• Низкая свобода (Миграция): Используйте точные шаги или скрипты.',
  'skills.create.placeholder.instructions':
    'например, Чтобы использовать этот навык, выполните следующую команду...',
  'skills.create.error.instructionsEmpty': 'Инструкции не могут быть пустыми.',
  'skills.create.error.valueEmpty': 'Пожалуйста, введите значение.',
  'skills.create.description.llmDescription':
    'Опишите, что должен делать этот навык и когда его следует использовать. (Будьте подробны для лучших результатов)',
  'skills.create.description.placeholder':
    'например, Навык, который форматирует JSON-строки в красиво распечатанный JSON...',
};
