...
export default {
  ...
  'toolDisplayName.Grep': '搜尋',
  'toolDisplayName.Glob': '比對檔案',
  'toolDisplayName.Shell': '終端',
  'toolDisplayName.Shell Command': '終端指令',
  'toolDisplayName.TodoWrite': '任務清單',
  'toolDisplayName.SaveMemory': '儲存記憶',
  'toolDisplayName.Agent': '智慧體',
  ...
  'toolDisplayName.EnterWorktree': '進入工作樹',
  'toolDisplayName.ExitWorktree': '退出工作樹',
