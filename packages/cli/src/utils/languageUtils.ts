 ...
 * This file handles the creation and maintenance of ~/.proto/output-language.md
...
/**
 * Returns the path to the LLM output language rule file (~/.proto/output-language.md).
 */
