...
export const TAB_COLORS = {
  ...
  IDLE: { r: 0, g: 215, b: 95 } as Color,
  /** Orange — busy / processing */
  BUSY: { r: 255, g: 149, b: 0 } as Color,
  /** Blue — waiting for user confirmation */
  WAITING: { r: 95, g: 135, b: 255 } as Color,
  /** Gray — status text color for idle state */
  IDLE_TEXT: { r: 136, g: 136, b: 136 } as Color,
} as const;
