  ...
  experimental: {
    ...
    properties: {
      ...
      enableParallelSubagents: {
        ...
        default: false,
        description:
          'Enable parallel execution of subagents. When disabled, subagents run sequentially (default behavior). Requires CLI restart to take effect.',
        showInDialog: true,
      },
      maxConcurrentSubagents: {
        ...
        default: 3,
        description:
          'Maximum number of subagents that can run concurrently. Only applies when parallel subagent execution is enabled. Recommended values: 3-5. Requires CLI restart to take effect.',
        showInDialog: true,
      },
    },
  },
