...
const SETTINGS_SCHEMA = {
  ...
  features: {
    ...
    requiresRestart: false,
    default: {},
    description: 'Optional UI and behavior toggles (fork / integration).',
    showInDialog: false,
    properties: {
      queuedMessageDisplay: {
        type: 'boolean',
        label: 'Show Queued Message Display',
        category: 'Advanced',
        requiresRestart: false,
        default: true,
        description:
          'Show queued user messages above the input while the model is responding.',
        showInDialog: false,
      },
    },
  },
