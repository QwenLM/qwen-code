  ...
  model: {
    ...
    properties: {
      ...
      goalCheckpointTimeoutSeconds: {
        ...
        description:
          "Deprecated. No effect: the Goal runtime no longer checkpoints its evidence, and the verifier's own timeout is fixed at 120 seconds. The key is still accepted so existing settings files validate, and it will be removed. When set it must be an integer between 1 and 900.",
        showInDialog: false,
      },
      maxToolCalls: {
        type: 'number',
