...
const SETTINGS_SCHEMA = {
  ...
  model: {
    ...
    properties: {
      ...
      loopEnabled: {
        type: 'boolean',
        label: 'Enable /loop Command',
        category: 'Features',
        requiresRestart: false,
        default: true,
        description: 'Enable or disable the /loop command system.',
        showInDialog: true,
      },
      loopMaxConcurrent: {
        type: 'number',
        ...
        requiresRestart: false,
        default: 50,
        description: 'Maximum number of concurrent loops (1-50).',
        showInDialog: false,
      },
      loopExpiryDays: {
        type: 'number',
        label: 'Loop Auto-Expiry (days)',
        category: 'Features',
        requiresRestart: false,
        default: 7,
        description:
          'Number of days before recurring loops auto-expire. Set to 0 to disable.',
        showInDialog: false,
      },
      loopJitterEnabled: {
        type: 'boolean',
        label: 'Enable Loop Jitter',
        category: 'Features',
        requiresRestart: false,
        default: true,
        description:
          'Add deterministic jitter to loop intervals to spread load.',
        showInDialog: false,
      },
      skipStartupContext: {
        type: 'boolean',
