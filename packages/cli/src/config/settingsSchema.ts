    ...
    properties: {
      ...
      chatCompression: {
        ...
        properties: {
          strategy: {
            type: 'enum',
            label: 'Chat Compression Strategy',
            category: 'Model',
            requiresRestart: true,
            ...
            options: [
              ...
              { value: 'notes', label: 'Notes and History' },
            ],
          },
          imageTokenEstimate: {
            type: 'number',
          ...
          maxRecentFilesToRetain: {
            type: 'number',
            label: 'Recent Files to Retain',
            category: 'Model',
            requiresRestart: true,
            default: undefined as number | undefined,
            showInDialog: false,
          },
          maxRecentImagesToRetain: {
            type: 'number',
            label: 'Recent Images to Retain',
            category: 'Model',
            requiresRestart: true,
            default: undefined as number | undefined,
            showInDialog: false,
          ...
          enableScreenshotTrigger: {
            type: 'boolean',
            label: 'Screenshot Compression Trigger',
            category: 'Model',
            requiresRestart: true,
          ...
          screenshotTriggerThreshold: {
            type: 'number',
            label: 'Screenshot Compression Threshold',
            category: 'Model',
            requiresRestart: true,
            default: undefined as number | undefined,
            showInDialog: false,
