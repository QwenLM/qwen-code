      ...
      async () => {
        ...
        try {
          ...
          while (nextMessage !== null) {
            if (ac.signal.aborted) {
              this.todoStopGuard.suspend();
              await finishBackgroundNotificationTurn('cancelled');
              return;
            }
            ...
            if (!sendResult.responseStream) {
              ...
              await finishBackgroundNotificationTurn(sendResult.stopReason);
              return;
            }
          ...
          try {
            ...
            await finishBackgroundNotificationTurn('end_turn');
          }
        } finally {
          this.config.endAutomaticActiveTodoWorkChain(promptId);
