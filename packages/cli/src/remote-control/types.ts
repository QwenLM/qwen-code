 ...
 * Note: token is NOT included in QR data for security reasons
 */
 ...
 * Note: secure flag is deprecated - TLS is not yet implemented
 */
export const DEFAULT_REMOTE_CONTROL_CONFIG: RemoteControlConfig = {
  port: 7373,
  host: 'localhost',
  secure: false, // Deprecated - TLS not yet implemented
  maxConnections: 5,
