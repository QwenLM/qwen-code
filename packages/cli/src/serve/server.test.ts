...
describe('createServeApp', () => {
  ...
  describe('GET /workspace/:id/sessions', () => {
    ...
    it.each([
      ...
      ['organized list', { view: 'organized' as const }],
      [
        'parent-filtered list',
        { parentSessionId: '00000000-0000-4000-8000-0000000000aa' },
      ],
    ])(
      'includes a live-only session on an untruncated first page even if it persists to disk between the scan and the existence check: %s',
      async (_name, options) => {
