...
import type { BridgeOptions } from '@qwen-code/acp-bridge/bridgeOptions';
...
vi.mock('@qwen-code/acp-bridge/spawnChannel', async (importOriginal) => {
  const actual =
    await importOriginal<
      typeof import('@qwen-code/acp-bridge/spawnChannel')
    >();
  return {
    ...actual,
...
vi.mock('@qwen-code/acp-bridge/bridge', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@qwen-code/acp-bridge/bridge')>();
  return {
    ...actual,
