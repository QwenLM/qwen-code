...
const allowedProcessEnvAccesses = normalizeAllowances([
  ...
  [
    ...
    {
      reason:
        'The Docker/Podman and Seatbelt launchers assemble sandboxed child ' +
        'environments: they pass through the process environment, forward ' +
        'provider keys, proxy settings, and debug switches, and read the ' +
        'SANDBOX_* control variables. The launcher entered the scanned serve/ ' +
        'layer via the #9146 leaf-layer move.',
      accesses: {
        'computed:envVar': 2,
        'key:BUILD_SANDBOX': 2,
        'key:COLORTERM': 2,
