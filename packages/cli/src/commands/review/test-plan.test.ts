    ...
    it('does not read a phase-named -pl value as the claimed lifecycle', () => {
      ...
      const bt = {
        ...
        test: [
          {
            command:
              './mvnw --batch-mode --no-transfer-progress -pl test -am test',
            exitCode: 0,
            seconds: 3,
            timedOut: false,
            output: '',
    ...
    it('contradicts a root-module claim on failures in the root project', () => {
      ...
      const failed = {
        ...
        test: [
          {
            command:
              './mvnw --batch-mode --no-transfer-progress -pl . -am test',
            exitCode: 1,
            seconds: 3,
            timedOut: false,
            output,
    ...
    it('does not read a quoted -am inside a -pl selector as the flag', () => {
      ...
      const failed = {
        ...
        test: [
          {
            command:
              "./mvnw --batch-mode --no-transfer-progress -pl 'foo -am bar' -am test",
            exitCode: 1,
            seconds: 3,
            timedOut: false,
            output: '[ERROR] Tests failed',
