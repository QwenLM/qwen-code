...
describe('auth command', () => {
  ...
  it('builds a removal notice with migration paths and no ANSI in non-TTY', () => {
    ...
    expect(notice).toContain('https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1');
    expect(notice).toContain('https://token-plan.ap-southeast-1.maas.aliyuncs.com/compatible-mode/v1');
