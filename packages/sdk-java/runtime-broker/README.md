...
implementations; JDBC implementations for shared durable state; and a
framework-neutral service that composes authoritative scope resolution,
Runtime provisioning, and Runtime transport adapters.
