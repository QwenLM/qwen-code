...
/**
 * The shared chat-panel message contract: an 11-variant discriminated union plus
 * the tool-call / todo shapes it nests. Daemon-free — hosts map their own data
 * onto these types. The `Daemon*` names are retained verbatim from web-shell so
 * the carve stays a move, not a rename (minimal blast radius).
 */
