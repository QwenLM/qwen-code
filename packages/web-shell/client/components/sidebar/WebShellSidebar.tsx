...
const FOOTER_OVERFLOW_PRIORITY: readonly WebShellSidebarFooterItem[] = [
  ...
  'splitView',
  'daemonStatus',
  // Goals sits just ahead of Scheduled Tasks: adding a button makes the footer
  // wider, so something has to yield sooner than it used to. Let the new one
  // absorb that pressure rather than pushing an existing button into the
  // overflow menu at a width where it used to stay inline.
  'goals',
  'scheduledTasks',
];
