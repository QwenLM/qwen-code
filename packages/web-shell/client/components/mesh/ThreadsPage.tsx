...
export interface ThreadsPageProps {
  agents: readonly MeshAgentSummaryView[];
...
export interface MeshAgentSummaryView {
  id: string;
  name: string;
  description?: string;
  color?: string;
...
export interface NewMeshAgent {
  name: string;
  description?: string;
  agentType?: string;
}

export interface NewMeshThread {
  title: string;
  body: string;
  assignee?: string;
}
      ...
      <div className={styles.pageBody}>
        {creating === 'agent' ? (
          <form className={styles.createForm} onSubmit={submitAgent}>
            ...
            <input className={styles.field} name="name" placeholder="Name, e.g. alice" required />
            <input className={styles.field} name="description" placeholder="Role or specialty" />
            <input className={styles.field} name="agentType" placeholder="Agent definition (optional)" />
            <div className={styles.formActions}>
              <Button type="button" variant="ghost" size="sm" onClick={() => setCreating(undefined)}>
                Cancel
              </Button>
              <Button type="submit" size="sm" disabled={pending}>Create agent</Button>
            </div>
          </form>
        ) : null}
