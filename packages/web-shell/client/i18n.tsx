...
const EN: Messages = {
  ...
  'desktopBrowser.title': 'Browser',
  'desktopBrowser.address': 'Address',
  'desktopBrowser.back': 'Back',
  'desktopBrowser.forward': 'Forward',
  'desktopBrowser.reload': 'Reload',
  'desktopBrowser.openExternal': 'Open in default browser',
  'desktopBrowser.close': 'Close browser',
  'desktopBrowser.httpOnly': 'Only HTTP(S) URLs can be opened.',
  ...
  'settings.label.ui.desktopLinkOpenPreference': 'Open web links',
  'settings.description.ui.desktopLinkOpenPreference':
    'Choose where HTTP(S) links open in the Electron desktop app. Mail links and Cmd/Ctrl-clicks always use the system.',
  'settings.option.ui.desktopLinkOpenPreference.inApp': 'In app',
  'settings.option.ui.desktopLinkOpenPreference.external': 'Default browser',
...
const ZH: Messages = {
  ...
  'desktopBrowser.title': '浏览器',
  'desktopBrowser.address': '地址',
  'desktopBrowser.back': '后退',
  'desktopBrowser.forward': '前进',
  'desktopBrowser.reload': '刷新',
  'desktopBrowser.openExternal': '在默认浏览器中打开',
  'desktopBrowser.close': '关闭浏览器',
  'desktopBrowser.httpOnly': '只能打开 HTTP(S) 链接。',
  ...
  'settings.label.ui.desktopLinkOpenPreference': '网页链接打开方式',
  'settings.description.ui.desktopLinkOpenPreference':
    '选择 Electron 桌面端中 HTTP(S) 链接的打开位置。邮件链接以及按住 Cmd/Ctrl 点击始终交给系统。',
  'settings.option.ui.desktopLinkOpenPreference.inApp': '应用内',
  'settings.option.ui.desktopLinkOpenPreference.external': '默认浏览器',
