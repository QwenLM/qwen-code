...
const EN: Messages = {
  ...
  'workspaceHost.chooseFolder': 'Use this folder',
  'workspaceHost.selectedFolder': 'Selected:',
  ...
  'workspaceHost.token': 'Bearer token (optional if already connected)',
  ...
  'sidebar.addWorkspaceDaemonHint': (vars) =>
    `Directory on ${vars?.address}. Enter an absolute path to browse matching folders on that server.`,
...
const ZH: Messages = {
  ...
  'workspaceHost.chooseFolder': '使用此目录',
  'workspaceHost.selectedFolder': '已选择：',
  ...
  'workspaceHost.token': 'Bearer token（已连接时可留空）',
  ...
  'sidebar.addWorkspaceDaemonHint': (vars) =>
    `目录位于 ${vars?.address}。输入绝对路径，可查看该服务器上的匹配目录。`,
