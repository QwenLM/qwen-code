...
const EN: Messages = {
  ...
  'workflowRuns.heading': 'Dynamic workflow traces',
  'workflowRuns.subtitle':
    'Run reusable definitions, inspect live orchestration, and replay completed runs.',
  ...
  'workflow.replay.label': 'Run replay',
  'workflow.replay.play': 'Play',
  'workflow.replay.pause': 'Pause',
  'workflow.replay.end': 'End',
  'workflow.replay.timeline': 'Replay timeline',
  'workflow.replay.events': (v) => `${v?.count ?? 0}/${v?.total ?? 0} events`,
  'workflow.replay.jumpToEvent': (v) =>
    `Jump to ${v?.title ?? ''}, ${v?.event ?? ''}, ${v?.time ?? ''}`,
  'workflow.replay.event.phase-started': 'Phase started',
  'workflow.replay.event.phase-completed': 'Phase completed',
  'workflow.replay.event.dispatch-queued': 'Agent queued',
  'workflow.replay.event.dispatch-started': 'Agent started',
  'workflow.replay.event.dispatch-completed': 'Agent completed',
  'workflow.replay.event.dispatch-failed': 'Agent failed',
  'workflow.replay.event.dispatch-cancelled': 'Agent cancelled',
  'workflow.replay.event.dispatch-cached': 'Agent restored from cache',
  'workflow.replay.event.log': 'Log',
  'workflow.replay.event.approval-requested': 'Approval requested',
  'workflow.replay.event.approval-settled': 'Approval settled',
  'workflow.replay.event.workflow-completed': 'Workflow completed',
  'workflow.replay.event.workflow-failed': 'Workflow failed',
  'workflow.replay.event.workflow-cancelled': 'Workflow cancelled',
  'workflow.replay.finalOutput': 'Final output',
  'workflow.replay.outputLines': (v) => `${v?.count ?? 0} lines`,
  'workflow.replay.logsUntimed': 'Log timestamps were not recorded.',
  'workflow.replay.logsTimed': 'Log timestamps are shown in replay.',
...
const ZH: Messages = {
  ...
  'workflowRuns.heading': 'Dynamic Workflow 执行轨迹',
  'workflowRuns.subtitle':
    '运行可复用定义、查看实时编排，并回放已经完成的执行。',
  ...
  'workflow.history.agents': 'Agents',
  'workflow.replay.label': '运行回放',
  'workflow.replay.play': '播放',
  'workflow.replay.pause': '暂停',
  'workflow.replay.end': '终点',
  'workflow.replay.timeline': '回放时间轴',
  'workflow.replay.events': (v) => `${v?.count ?? 0}/${v?.total ?? 0} 个事件`,
  'workflow.replay.jumpToEvent': (v) =>
    `跳转到 ${v?.title ?? ''}，${v?.event ?? ''}，${v?.time ?? ''}`,
  'workflow.replay.event.phase-started': '阶段开始',
  'workflow.replay.event.phase-completed': '阶段完成',
  'workflow.replay.event.dispatch-queued': 'Agent 进入队列',
  'workflow.replay.event.dispatch-started': 'Agent 开始运行',
  'workflow.replay.event.dispatch-completed': 'Agent 完成',
  'workflow.replay.event.dispatch-failed': 'Agent 失败',
  'workflow.replay.event.dispatch-cancelled': 'Agent 已取消',
  'workflow.replay.event.dispatch-cached': 'Agent 从缓存恢复',
  'workflow.replay.event.log': '日志',
  'workflow.replay.event.approval-requested': '发起审批',
  'workflow.replay.event.approval-settled': '审批已处理',
  'workflow.replay.event.workflow-completed': 'Workflow 完成',
  'workflow.replay.event.workflow-failed': 'Workflow 失败',
  'workflow.replay.event.workflow-cancelled': 'Workflow 已取消',
  'workflow.replay.finalOutput': '最终输出',
  'workflow.replay.outputLines': (v) => `${v?.count ?? 0} 行`,
  'workflow.replay.logsUntimed': '本次运行未记录日志时间戳。',
  'workflow.replay.logsTimed': '日志时间戳已显示在回放中。',
