...
const ZH: Messages = {
  ...
  // `localizeToolDisplayName`. A product name (e.g. `Notebook`) stays verbatim.
  'toolName.edit': '编辑',
  'toolName.write_file': '写入文件',
  'toolName.read_file': '读取文件',
  'toolName.grep_search': '搜索',
  'toolName.glob': '匹配文件',
  'toolName.run_shell_command': '终端',
  ...
  'toolName.enter_worktree': '进入工作树',
  'toolName.exit_worktree': '退出工作树',
