...
const EN: Messages = {
  ...
  'live.installHost': 'Install Live Host',
  ...
  'live.openCoordinator': 'Open conversation',
  'live.openWorker': (v) => `Open task ${v?.index ?? ''}`,
  'live.requirement.host': 'Qwen Live Host',
  'live.requirement.microphone': 'Microphone',
  'live.requirement.inputMonitoring': 'Input Monitoring',
  ...
  'live.requirement.globalShortcut': 'DoubleCommand shortcut',
...
const ZH: Messages = {
  ...
  'live.openCoordinator': '打开当前对话',
  'live.openWorker': (v) => `打开任务 ${v?.index ?? ''}`,
  'live.requirement.host': 'Qwen Live Host',
  'live.requirement.microphone': '麦克风',
  'live.requirement.inputMonitoring': '输入监控',
  ...
  'live.requirement.globalShortcut': '双击 Command 快捷键',
  'live.requirement.appshot': 'Appshot',
