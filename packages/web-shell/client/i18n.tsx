...
const EN: Messages = {
  ...
  'workspaceHost.recentServers': 'Recent servers',
  'workspaceHost.openHost': (vars) => `Open ${vars?.host}`,
  'workspaceHost.token': 'Bearer token',
  'workspaceHost.tokenHint':
    'Optional if this browser has already connected to the server.',
  'workspaceHost.next': 'Next: choose folder',
  'workspaceHost.back': 'Change computer',
  'workspaceHost.connecting': 'Connecting…',
  ...
  'sidebar.addWorkspaceDaemonHint': (vars) =>
    `Folder on ${vars?.address}. Click a folder to open it, then add the folder shown above.`,
...
const ZH: Messages = {
  ...
  'workspaceHost.thisComputer': '这台电脑',
  ...
  'workspaceHost.recentServers': '最近使用的服务器',
  'workspaceHost.openHost': (vars) => `打开 ${vars?.host}`,
  'workspaceHost.token': 'Bearer token',
  'workspaceHost.tokenHint': '本浏览器已连接过该服务器时可留空。',
  'workspaceHost.next': '下一步：选择目录',
  'workspaceHost.back': '更换计算机',
  'workspaceHost.connecting': '正在连接…',
  ...
  'sidebar.addWorkspaceDaemonHint': (vars) =>
    `目录位于 ${vars?.address}。点击列表中的文件夹进入，再添加上方显示的目录。`,
