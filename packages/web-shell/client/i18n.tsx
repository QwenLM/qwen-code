...
const EN: Messages = {
  ...
  'scheduledTasks.delivery.destination': 'Send result to',
  'scheduledTasks.delivery.placeholder':
    'Optional — search or paste a recent chat ID',
  'scheduledTasks.delivery.loading': 'Loading recent chats…',
  'scheduledTasks.delivery.empty': 'No recent chats are available.',
  'scheduledTasks.delivery.hint':
    'Choose a direct chat, group, or topic observed in this workspace.',
  'scheduledTasks.delivery.unobserved':
    'Choose a recently observed destination.',
  'scheduledTasks.delivery.kind.direct': 'Direct',
  'scheduledTasks.delivery.kind.group': 'Group',
  'scheduledTasks.delivery.kind.topic': 'Topic',
...
const ZH: Messages = {
  ...
  'scheduledTasks.delivery.destination': '结果发送到',
  'scheduledTasks.delivery.placeholder': '可选：搜索或粘贴最近会话 ID',
  'scheduledTasks.delivery.loading': '正在加载最近会话…',
  'scheduledTasks.delivery.empty': '暂无可用的最近会话。',
  'scheduledTasks.delivery.hint': '选择本工作区已观测的单聊、群聊或话题。',
  'scheduledTasks.delivery.unobserved': '请选择最近观测到的发送目标。',
  'scheduledTasks.delivery.kind.direct': '单聊',
  'scheduledTasks.delivery.kind.group': '群聊',
  'scheduledTasks.delivery.kind.topic': '话题',
