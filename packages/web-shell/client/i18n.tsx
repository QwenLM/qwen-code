...
export const EN: Messages = {
  ...
  'gitDiff.source.label': 'Compare',
  'gitDiff.source.uncommitted': 'Uncommitted',
  'gitDiff.source.unstaged': 'Unstaged',
  'gitDiff.source.staged': 'Staged',
  'gitDiff.source.commit': 'Committed',
  ...
  'gitDiff.comparisonUnavailable': 'This comparison is not available',
  ...
  'gitDiff.retry': 'Retry',
  'gitDiff.noCommitsToCompare': 'No commits to compare',
  'gitDiff.noBranchesToCompare': 'No other branches to compare',
  'gitMode.title': 'Git mode',
  'gitMode.current': 'Current branch',
  'gitMode.currentDesc': (v) => `Develop directly on ${v?.branch ?? 'main'}`,
  'gitMode.existing': 'Existing branch',
  'gitMode.existingDesc': 'Switch to another branch',
...
export const ZH: Messages = {
  ...
  'gitDiff.title': '变更',
  'gitDiff.source.label': '比较',
  'gitDiff.source.uncommitted': '未提交',
  'gitDiff.source.unstaged': '未暂存',
  'gitDiff.source.staged': '已暂存',
  'gitDiff.source.commit': '已提交',
  ...
  'gitDiff.comparisonUnavailable': '该比较不可用',
  ...
  'gitDiff.retry': '重试',
  'gitDiff.noCommitsToCompare': '没有可比较的提交',
  'gitDiff.noBranchesToCompare': '没有其他可比较的分支',
  'gitMode.title': 'Git 模式',
  'gitMode.current': '当前分支',
  'gitMode.currentDesc': (v) => `直接在 ${v?.branch ?? 'main'} 上开发`,
  'gitMode.existing': '已有分支',
  'gitMode.existingDesc': '切换到其他分支',
