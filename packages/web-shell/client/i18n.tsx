...
const EN: Messages = {
  ...
  'workflow.empty.eyebrow': 'Session workflow',
  ...
  'workflow.tabs.label': 'Workflow views',
  'workflow.tabs.task': 'Overview',
  ...
  'workflow.attention.emptyCopy':
    'Agent failures and cancellations appear here; normal dependency waits do not.',
...
const ZH: Messages = {
  ...
  'workflow.attention.emptyCopy':
    'Agent 失败和取消会自动进入这里；普通依赖等待不会制造噪音。',
