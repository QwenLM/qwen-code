...
const EN: Messages = {
  ...
  'sidebar.pinnedWorkspace': 'Pinned workspace',
  'sidebar.pinWorkspaceFailed': 'Failed to update workspace pin state',
...
const ZH: Messages = {
  ...
  'sidebar.pinnedWorkspace': '已置顶的工作区',
  'sidebar.pinWorkspaceFailed': '更新工作区置顶状态失败',
