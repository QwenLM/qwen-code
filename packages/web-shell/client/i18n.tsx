...
const EN: Messages = {
  ...
  'planExecution.navigateToStep': 'Navigate to step {{label}}',
  'workflow.dependencies.navigateTo': 'Navigate to step {{step}}',
  'workflow.inspector.keyboardNavLabel':
    'Workflow inspector. Use arrow keys to navigate between connected steps.',
  'workflow.activity.showAll': 'Show all ({{count}})',
  'workflow.activity.showLess': 'Show less',
...
const ZH: Messages = {
  ...
  'planExecution.navigateToStep': '导航到步骤 {{label}}',
  'workflow.dependencies.navigateTo': '导航到步骤 {{step}}',
  'workflow.inspector.keyboardNavLabel':
    '工作流检查器。使用方向键在关联步骤间导航。',
  'workflow.activity.showAll': '显示全部 ({{count}})',
  'workflow.activity.showLess': '收起',
