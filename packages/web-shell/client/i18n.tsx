...
const EN: Messages = {
  ...
  'settings.models.runtimeSyncFailed':
    'The change was saved, but running sessions could not be refreshed. Retry or restart qwen serve before using the updated model list.',
...
const ZH: Messages = {
  ...
  'settings.models.runtimeSyncFailed':
    '更改已保存，但无法刷新正在运行的会话。请重试，或重启 qwen serve 后再使用更新后的模型列表。',
