...
const ZH: Messages = {
  ...
  'daemon.usage.heatmapSub': (v) =>
    `最近 ${v?.months ?? 6} 个月 · 每日 token 汇总`,
  'daemon.usage.low': '少',
  'daemon.usage.high': '多',
  'daemon.usage.dowMon': '一',
  'daemon.usage.dowWed': '三',
  'daemon.usage.dowFri': '五',
  'daemon.usage.streak': (v) => `连续 ${v?.days ?? 0} 天`,
