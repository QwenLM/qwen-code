...
const EN: Messages = {
  ...
  'workspaceHost.locationSubtitle': 'Choose where the folder lives.',
  'workspaceHost.local': 'Local',
  'workspaceHost.localHint': 'Use a folder on this computer.',
  'workspaceHost.remote': 'Remote',
  'workspaceHost.remoteHint': 'Use a folder on a connected computer.',
  'workspaceHost.computer': 'Connected computer',
  'workspaceHost.noRemoteConnections':
    'Connect a computer in Daemon Status first.',
  'workspaceHost.connectComputer': 'Connect a computer',
  'workspaceHost.next': 'Choose folder',
  'workspaceHost.changeLocation': 'Change location',
...
const ZH: Messages = {
  ...
  'workspaceHost.locationSubtitle': '选择目录所在的位置。',
  'workspaceHost.local': '本地',
  'workspaceHost.localHint': '使用这台电脑上的文件夹。',
  'workspaceHost.remote': '远程',
  'workspaceHost.remoteHint': '使用已连接计算机上的文件夹。',
  'workspaceHost.computer': '已连接的计算机',
  'workspaceHost.noRemoteConnections': '请先在 Daemon 状态中连接一台计算机。',
  'workspaceHost.connectComputer': '连接一台计算机',
  'workspaceHost.next': '选择目录',
  'workspaceHost.changeLocation': '更改位置',
