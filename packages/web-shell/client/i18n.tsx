...
const EN: Messages = {
  ...
  'tasks.detail.outputEmpty': 'No output yet',
  'tasks.detail.outputUnavailable': 'Output is unavailable',
  'tasks.detail.outputTruncated': 'Showing the latest 64 KiB',
...
const ZH: Messages = {
  ...
  'tasks.detail.output': '输出',
  'tasks.detail.outputEmpty': '暂无输出',
  'tasks.detail.outputUnavailable': '输出暂时不可用',
  'tasks.detail.outputTruncated': '仅显示最近 64 KiB',
