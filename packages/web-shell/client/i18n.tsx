...
const EN: Messages = {
  ...
  'workflow.planReview.journeyTitle': 'From goal to execution',
  'workflow.planReview.journeyHint':
    'Execution starts only after you confirm the plan',
  'workflow.planReview.stepGoal': 'Describe the goal',
  'workflow.planReview.stepGoalCopy': 'Goal captured for this session',
  'workflow.planReview.stepContext': 'Confirm understanding',
  'workflow.planReview.stepContextCopy': 'Read-only analysis complete',
  'workflow.planReview.stepPreview': 'Preview the plan',
  'workflow.planReview.stepPreviewCopy':
    'Review steps, dependencies, and parallel work',
  'workflow.planReview.stepAuthorize': 'Authorize and start',
  'workflow.planReview.stepAuthorizeCopy':
    'Collaboration starts after confirmation',
  'workflow.planReview.graphEyebrow': 'Step 03 · Execution graph',
  'workflow.planReview.defaultTask': 'Current collaboration task',
  'workflow.planReview.defaultGoal':
    'A structured execution plan is ready for review.',
  'workflow.planReview.executionSteps': 'Execution steps',
  'workflow.planReview.dependencies': 'Dependencies',
  'workflow.planReview.parallelStarts': 'Parallel starting points',
  'workflow.planReview.guardrailsEyebrow': 'Step 04 · Guardrails',
  'workflow.planReview.guardrailsTitle': 'Confirm boundaries and start',
  'workflow.planReview.guardrailsCopy':
    'Agents can execute this revision only after approval.',
  'workflow.empty.eyebrow': 'Session cockpit',
  ...
  'workflow.tabs.label': 'Cockpit views',
  'workflow.tabs.task': 'Collaboration',
  ...
  'workflow.attention.eyebrow': 'Human in the loop',
  'workflow.attention.title': 'Needs attention',
  'workflow.attention.copy':
    'Only items that require user intervention are shown here.',
  'workflow.attention.count': 'Needs action',
  'workflow.attention.failed': 'Agent failures',
  'workflow.attention.cancelled': 'Cancelled',
  'workflow.attention.running': 'Still running',
  'workflow.attention.queue': 'Decision queue',
  'workflow.attention.queueOrder': 'Workflow order',
  'workflow.attention.waiting': 'Waiting for your decision',
  ...
  'workflow.attention.emptyTitle': 'Nothing currently needs your attention',
  'workflow.attention.emptyCopy':
    'Plan approvals and Agent failures appear here; normal dependency waits do not.',
  'workflow.session.defaultTitle': 'Current Session Workflow',
  'workflow.session.workspace': 'workspace',
  'workflow.session.steps': (v) => `${v?.count ?? 0} steps`,
  'workflow.session.agentCalls': (v) => `${v?.count ?? 0} Agent calls`,
  'workflow.overview.label': 'Task overview',
  'workflow.overview.progress': 'Overall progress',
  'workflow.overview.activeAgents': 'Agents working',
  'workflow.overview.completedSteps': 'Steps completed',
  'workflow.overview.agentRecords': 'Agent runs',
  'workflow.overview.attention': 'Needs attention',
  'workflow.overview.noAttention': 'None',
  'workflow.plan.title': 'Execution plan',
  'workflow.plan.subtitle': (v) =>
    `${v?.count ?? 0} nodes · Select one for details`,
  'workflow.plan.agentCount': (v) => `${v?.count ?? 0} Agents`,
  'workflow.stage.work': 'Work area',
  'workflow.stage.activity': 'Agent activity',
  'workflow.sessionState.reconnecting': 'Reconnecting',
  'workflow.sessionState.live': 'Live',
  'workflow.sessionState.history': 'History',
  'workflow.sessionState.ready': 'Ready',
  'workflow.stage.session': (v) => `${v?.state ?? ''} session`,
  'workflow.activity.empty': 'No Agent runs are linked to a Todo yet.',
  'workflow.runtime.duration': 'Duration',
  'workflow.runtime.currentAction': 'Current action',
  'workflow.runtime.stepCompleted': 'Step completed.',
  'workflow.runtime.waitUpstream':
    'Waiting for upstream dependencies before starting.',
  'workflow.runtime.waitStart': 'Waiting to start.',
  'workflow.dependencies.upstream': 'Upstream dependencies',
  'workflow.dependencies.none': 'None, ready to start',
  'workflow.dependencies.unblocks': 'Unlocks after completion',
  'workflow.dependencies.noDownstream': 'No downstream nodes',
  'workflow.agent.failed': 'Failed',
  'workflow.agent.completed': 'Completed',
  'workflow.agent.metrics': (v) =>
    `${v?.tools ?? 0} tool calls · ${v?.tokens ?? 0} tokens`,
  'workflow.agent.metricsMissing': 'Execution metrics unavailable',
  'workflow.agent.openTranscript': 'Open persisted transcript for full output',
  'workflow.agent.skills': (v) => `Skills: ${v?.skills ?? ''}`,
  'workflow.agent.openDetails': 'Open details →',
  'workflow.agent.mainCompleted':
    'This step was completed by the main Agent without a Subagent.',
  'workflow.agent.notStarted': 'No Subagent has started for this step.',
  'workflow.review.title': 'Checks and decisions',
  'workflow.review.subtitle': 'Derived from the same Workflow state',
  'workflow.review.attentionCode': 'Attention',
  'workflow.review.readyCode': 'Ready',
  'workflow.review.attentionTitle': '⚠ Human intervention required',
  'workflow.review.normalTitle': '✓ Current state is healthy',
  'workflow.review.attentionCopy': (v) => `${v?.count ?? 0} items need action.`,
  'workflow.review.normalCopy':
    'No failed or cancelled Agents; dependency waits are normal.',
  'workflow.review.structuredPlan': 'Structured plan',
  'workflow.review.stableIds': (v) => `${v?.count ?? 0} Todos have stable IDs`,
  'workflow.review.dependencyTopology': 'Dependency topology',
  'workflow.review.edgeCount': (v) =>
    `${v?.count ?? 0} blockedBy relationships`,
  'workflow.review.edgesCode': 'Edges',
  'workflow.review.agentExecution': 'Agent execution',
  'workflow.review.agentRecords': (v) => `${v?.count ?? 0} linked runs`,
  'workflow.review.checkCode': 'Check',
  'workflow.review.history': 'History replay',
  'workflow.review.historyCopy':
    'Agent details remain available after completion',
  'workflow.review.partialCode': 'Partial',
  'workflow.evidence.toolCalls': 'Tool calls',
  'workflow.evidence.tokens': 'Agent tokens',
  'workflow.evidence.completedNodes': 'Completed nodes',
  'workflow.evidence.artifacts': 'Session artifacts',
  'workflow.actions.attention': 'Open needs attention',
  'workflow.actions.back': 'Return to Chat',
  'workflow.collaboration.title': 'Collaboration activity',
  'workflow.collaboration.subtitle':
    'Agents hand off through Todos, tool calls, and artifacts',
  'workflow.collaboration.fullActivity': 'View full activity',
  'workflow.collaboration.noSubagents':
    'No Subagents were started for this Workflow.',
  'workflow.collaboration.waiting': 'Waiting for an Agent to start.',
  'workflow.deliverables.title': 'Current deliverables',
  'workflow.deliverables.count': (v) => `${v?.count ?? 0} Session artifacts`,
  ...
  'workflow.status.blocked': 'Waiting for dependencies',
  ...
  'workflow.task.waitingPlan': 'Waiting for plan',
...
const ZH: Messages = {
  ...
  'workflow.planReview.journeyTitle': '从目标到执行',
  'workflow.planReview.journeyHint': '确认计划后才会开始执行',
  'workflow.planReview.stepGoal': '描述目标',
  'workflow.planReview.stepGoalCopy': '目标已进入当前会话',
  'workflow.planReview.stepContext': '确认理解',
  'workflow.planReview.stepContextCopy': '模型已完成只读分析',
  'workflow.planReview.stepPreview': '预览计划',
  'workflow.planReview.stepPreviewCopy': '检查节点、依赖与并行关系',
  'workflow.planReview.stepAuthorize': '授权并启动',
  'workflow.planReview.stepAuthorizeCopy': '确认后才开始协作',
  'workflow.planReview.graphEyebrow': '第 03 步 · 执行图',
  'workflow.planReview.defaultTask': '当前协作任务',
  'workflow.planReview.defaultGoal': '模型已生成结构化执行计划，请确认后继续。',
  'workflow.planReview.executionSteps': '执行步骤',
  'workflow.planReview.dependencies': '依赖关系',
  'workflow.planReview.parallelStarts': '可并行起点',
  'workflow.planReview.guardrailsEyebrow': '第 04 步 · 执行边界',
  'workflow.planReview.guardrailsTitle': '确认边界并启动',
  'workflow.planReview.guardrailsCopy':
    '批准后，Agent 才能按照这个版本继续执行。',
  'workflow.empty.eyebrow': '会话驾驶舱',
  'workflow.empty.title': '这个会话还没有结构化工作流',
  'workflow.empty.copy':
    '返回对话，进入计划并审阅，让模型先写入带稳定 ID 和依赖的待办。',
  'workflow.empty.action': '返回对话创建计划',
  'workflow.tabs.label': '驾驶舱视图',
  'workflow.tabs.task': '协作任务',
  'workflow.tabs.attention': '待我处理',
  'workflow.connection.connected': 'Daemon 已连接',
  'workflow.connection.reconnecting': 'Daemon 正在重连',
  'workflow.attention.eyebrow': '人工决策',
  'workflow.attention.title': '待我处理',
  'workflow.attention.copy':
    '这里只展示 Agent 无法自行处理、需要用户介入的节点。',
  'workflow.attention.count': '需要处理',
  'workflow.attention.failed': 'Agent 失败',
  'workflow.attention.cancelled': '已取消',
  'workflow.attention.running': '仍在运行',
  'workflow.attention.queue': '决策队列',
  'workflow.attention.queueOrder': '按工作流顺序',
  'workflow.attention.waiting': '等待用户决策',
  ...
  'workflow.attention.emptyTitle': '当前没有需要人工处理的节点',
  'workflow.attention.emptyCopy':
    '计划审批和 Agent 异常会自动进入这里；普通依赖等待不会制造噪音。',
  'workflow.session.defaultTitle': '当前会话工作流',
  'workflow.session.workspace': '工作区',
  'workflow.session.steps': (v) => `${v?.count ?? 0} 个步骤`,
  'workflow.session.agentCalls': (v) => `${v?.count ?? 0} 个 Agent 调用`,
  'workflow.overview.label': '任务概况',
  'workflow.overview.progress': '整体进度',
  'workflow.overview.activeAgents': 'Agent 正在工作',
  'workflow.overview.completedSteps': '步骤已完成',
  'workflow.overview.agentRecords': 'Agent 执行记录',
  'workflow.overview.attention': '需要人工处理',
  'workflow.overview.noAttention': '无需处理',
  'workflow.plan.title': '执行计划',
  'workflow.plan.subtitle': (v) => `${v?.count ?? 0} 个节点 · 点击查看详情`,
  'workflow.plan.agentCount': (v) => `${v?.count ?? 0} 个 Agent`,
  'workflow.stage.work': '工作现场',
  'workflow.stage.activity': 'Agent 记录',
  'workflow.sessionState.reconnecting': '正在重连',
  'workflow.sessionState.live': '实时',
  'workflow.sessionState.history': '历史',
  'workflow.sessionState.ready': '就绪',
  'workflow.stage.session': (v) => `${v?.state ?? ''}会话`,
  'workflow.activity.empty': '还没有关联到待办的 Agent 执行。',
  'workflow.runtime.duration': '执行耗时',
  'workflow.runtime.currentAction': '当前动作',
  'workflow.runtime.stepCompleted': '步骤已完成。',
  'workflow.runtime.waitUpstream': '等待上游依赖完成后开始执行。',
  'workflow.runtime.waitStart': '等待开始执行。',
  'workflow.dependencies.upstream': '上游依赖',
  'workflow.dependencies.none': '无，可直接开始',
  'workflow.dependencies.unblocks': '完成后解锁',
  'workflow.dependencies.noDownstream': '无下游节点',
  'workflow.agent.failed': '失败',
  'workflow.agent.completed': '已完成',
  'workflow.agent.metrics': (v) =>
    `${v?.tools ?? 0} 次工具调用 · ${v?.tokens ?? 0} tokens`,
  'workflow.agent.metricsMissing': '执行指标未记录',
  'workflow.agent.openTranscript': '打开持久化执行记录查看完整输出',
  'workflow.agent.skills': (v) => `技能：${v?.skills ?? ''}`,
  'workflow.agent.openDetails': '打开详情 →',
  'workflow.agent.mainCompleted': '此步骤由主 Agent 完成，未启动子 Agent。',
  'workflow.agent.notStarted': '这个步骤还没有启动子 Agent。',
  'workflow.review.title': '检查与决策',
  'workflow.review.subtitle': '来自同一工作流状态',
  'workflow.review.attentionCode': '待处理',
  'workflow.review.readyCode': '就绪',
  'workflow.review.attentionTitle': '⚠ 需要人工介入',
  'workflow.review.normalTitle': '✓ 当前状态正常',
  'workflow.review.attentionCopy': (v) => `${v?.count ?? 0} 项需要处理。`,
  'workflow.review.normalCopy':
    '没有失败或取消的 Agent；依赖等待属于正常执行状态。',
  'workflow.review.structuredPlan': '结构化计划',
  'workflow.review.stableIds': (v) => `${v?.count ?? 0} 个待办均有稳定 ID`,
  'workflow.review.dependencyTopology': '依赖拓扑',
  'workflow.review.edgeCount': (v) => `${v?.count ?? 0} 条 blockedBy 关系`,
  'workflow.review.edgesCode': '依赖',
  'workflow.review.agentExecution': 'Agent 执行',
  'workflow.review.agentRecords': (v) => `${v?.count ?? 0} 条关联记录`,
  'workflow.review.checkCode': '检查',
  'workflow.review.history': '历史可回放',
  'workflow.review.historyCopy': '完成后仍可打开 Agent 详情',
  'workflow.review.partialCode': '部分',
  'workflow.evidence.toolCalls': '工具调用',
  'workflow.evidence.tokens': 'Agent tokens',
  'workflow.evidence.completedNodes': '完成节点',
  'workflow.evidence.artifacts': '会话产物',
  'workflow.actions.attention': '进入待我处理',
  'workflow.actions.back': '回到对话继续协作',
  'workflow.collaboration.title': '协作记录',
  'workflow.collaboration.subtitle': 'Agent 通过待办、工具调用和产物交接',
  'workflow.collaboration.fullActivity': '查看完整记录',
  'workflow.collaboration.noSubagents': '本次工作流未启动子 Agent。',
  'workflow.collaboration.waiting': '等待 Agent 开始执行。',
  'workflow.deliverables.title': '当前交付包',
  'workflow.deliverables.count': (v) => `${v?.count ?? 0} 个会话产物`,
  'workflow.deliverables.none': '尚未发布产物',
  'workflow.status.running': '运行中',
  'workflow.status.paused': '已暂停',
  'workflow.status.completed': '已完成',
  'workflow.status.blocked': '等待依赖',
  'workflow.status.inProgress': '处理中',
  'workflow.status.ready': '待执行',
  ...
  'workflow.task.waitingPlan': '等待计划',
