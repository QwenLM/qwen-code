...
const EN: Messages = {
  ...
  'sidebar.channelsAttention': 'Channels need attention',
  ...
  'settings.channels.description':
    'Manage messaging channels for this workspace.',
  'settings.channels.action': 'Manage channels',
  'channels.title': 'Channels',
  'channels.summary': (v) =>
    `${v?.workspace ?? ''} · ${v?.count ?? 0} configured`,
  'channels.workspace.current': 'Current workspace',
  'channels.loading': 'Loading channels',
  'channels.type.unknown': 'Unknown type',
  ...
  'channels.startsWithServe': 'Starts with serve',
  ...
  'channels.stale.title': 'Channel settings are out of date',
  'channels.stale.description':
    'Configuration changes are disabled until the workspace snapshot reloads successfully. Runtime controls remain available.',
  'channels.authUnavailable.title': 'QR authentication is unavailable',
  'channels.authUnavailable.token':
    'Restart Qwen Code with a bearer token to authenticate this channel.',
  'channels.authUnavailable.capability':
    'Update Qwen Code to a version that supports channel authentication.',
  'channels.loadError.title': 'Channels could not be loaded',
  'channels.loadError.retryLabel': 'Retry loading channels',
  ...
  'channels.yours': 'Your channels',
  'channels.connectAnother': 'Connect another platform',
  'channels.viewAllPlatforms': 'View all platforms',
  'channels.details.title': 'Channel details',
  'channels.details.status': 'Status',
  'channels.details.configuration': 'Configuration',
  'channels.details.runtime': 'Runtime',
  'channels.details.closeNamed': (v) => `Close details for ${v?.name ?? ''}`,
  'channels.details.openNamed': (v) => `View details for ${v?.name ?? ''}`,
  'channels.pairing.title': 'Pairing requests',
  'channels.pairing.refresh': 'Refresh pairing requests',
  'channels.pairing.tokenRequired':
    'A bearer token is required to view pairing codes.',
  'channels.pairing.empty': 'No pending pairing requests.',
  'channels.pairing.ageMinutes': (v) => `${v?.count ?? 0} min ago`,
  'channels.pairing.allow': 'Allow',
  'channels.pairing.allowNamed': (v) => `Allow ${v?.name ?? ''}`,
  'channels.pairing.approved': (v) =>
    `${v?.name ?? ''} is allowed. Ask them to send the message again.`,
  'channels.platformPicker.title': 'Add channel',
  'channels.platformPicker.description':
    'Choose where Qwen Code should receive messages. You can connect the same platform more than once.',
  'channels.platformPicker.search': 'Search platforms',
  'channels.platformPicker.empty': 'No matching platforms',
  'channels.platformPicker.auth.qr': 'QR code',
  'channels.platformPicker.auth.credentials': 'Credentials',
  'channels.platformPicker.auth.qrOrCredentials': 'QR or credentials',
  'channels.configurationReadOnly': 'Configuration is read-only',
  'channels.runtimeError': 'Channel runtime error',
  'channels.actionError': 'Channel action failed',
  'channels.error.refreshUnavailable': (v) =>
    `${v?.error ?? ''} Channel settings could not be refreshed.`,
  'channels.error.refreshFailed': (v) =>
    `${v?.error ?? ''} Refresh failed: ${v?.refreshError ?? ''}`,
  'channels.action.back': 'Back',
  'channels.action.add': 'Add channel',
  'channels.action.cancel': 'Cancel',
  'channels.action.save': 'Save',
  'channels.action.close': 'Close',
  'channels.action.delete': 'Delete channel',
  'channels.action.dismiss': 'Dismiss',
  'channels.action.start': 'Start',
  'channels.action.stop': 'Stop',
  'channels.action.restart': 'Restart',
  'channels.action.retry': 'Retry',
  'channels.action.authenticate': 'Authenticate',
  'channels.action.startWithServe': 'Start with serve',
  'channels.action.editConfiguration': 'Edit configuration',
  'channels.action.authenticateAgain': 'Authenticate again',
  'channels.action.deleteMenu': 'Delete channel…',
  'channels.action.saveChanges': 'Save changes',
  'channels.action.saveAndContinue': 'Save and continue',
  'channels.action.saveAuthentication': 'Save authentication',
  'channels.action.startNamed': (v) => `Start ${v?.name ?? ''}`,
  'channels.action.stopNamed': (v) => `Stop ${v?.name ?? ''}`,
  'channels.action.restartNamed': (v) => `Restart ${v?.name ?? ''}`,
  'channels.action.retryNamed': (v) => `Retry ${v?.name ?? ''}`,
  'channels.action.moreNamed': (v) => `More actions for ${v?.name ?? ''}`,
  'channels.action.editNamed': (v) => `Edit ${v?.name ?? ''}`,
  'channels.action.deleteNamed': (v) => `Delete ${v?.name ?? ''}`,
  'channels.action.authenticateNamed': (v) => `Authenticate ${v?.name ?? ''}`,
  ...
  'channels.delete.descriptionNamed': (v) =>
    `${v?.name ?? ''} will be removed from this workspace.`,
  'channels.editor.title.add': 'Add channel',
  'channels.editor.title.connect': (v) => `Connect ${v?.type ?? ''}`,
  'channels.editor.title.edit': (v) => `Edit ${v?.name ?? ''}`,
  'channels.editor.description':
    'Configure this workspace connection. Stored credentials are never shown.',
  'channels.editor.currentWorkspace': 'Current workspace',
  'channels.dingtalk.title': 'Configure DingTalk',
  'channels.dingtalk.description':
    'Enter the Client ID and Client Secret from your DingTalk application.',
  'channels.dingtalk.clientId': 'Client ID (AppKey)',
  'channels.dingtalk.clientIdPlaceholder': 'Enter Client ID',
  'channels.dingtalk.clientSecret': 'Client Secret (AppSecret)',
  'channels.dingtalk.clientSecretPlaceholder': 'Enter Client Secret',
  'channels.dingtalk.clientSecretStored': 'Stored Client Secret',
  'channels.dingtalk.docs': 'Setup guide',
  'channels.dingtalk.accessPolicy': 'Access policy',
  'channels.dingtalk.policy.pairing.title': 'Pairing',
  'channels.dingtalk.policy.pairing.summary':
    'People can chat after you approve them',
  'channels.dingtalk.policy.pairing.description':
    'After saving, a direct message or @mention returns a pairing code. Only approved people can use this channel, including in group chats. After approval, ask them to send the message again.',
  'channels.dingtalk.policy.open.title': 'Open',
  'channels.dingtalk.policy.open.summary':
    'Anyone or any group can chat directly',
  'channels.feishu.title': 'Configure Feishu',
  'channels.feishu.description':
    'Enter the App ID and App Secret for an existing Feishu app.',
  'channels.feishu.appId': 'App ID',
  'channels.feishu.appIdPlaceholder': 'Enter App ID',
  'channels.feishu.appSecret': 'App Secret',
  'channels.feishu.appSecretPlaceholder': 'Enter App Secret',
  'channels.feishu.appSecretStored': 'Stored App Secret',
  'channels.wecom.title': 'Configure WeCom',
  'channels.wecom.description':
    'Enter the Bot ID and Bot Secret for an existing WeCom intelligent bot.',
  'channels.wecom.botId': 'Bot ID',
  'channels.wecom.botIdPlaceholder': 'Enter Bot ID',
  'channels.wecom.botSecret': 'Bot Secret',
  'channels.wecom.botSecretPlaceholder': 'Enter Bot Secret',
  'channels.wecom.botSecretStored': 'Stored Bot Secret',
  'channels.credentialPolicy.docs': 'Setup guide',
  'channels.credentialPolicy.accessPolicy': 'Access policy',
  'channels.credentialPolicy.pairing.title': 'Pairing',
  'channels.credentialPolicy.pairing.summary':
    'People can chat after you approve them',
  'channels.credentialPolicy.pairing.description':
    'After saving, a direct message or @mention returns a pairing code. Only approved people can use this channel, including in group chats. After approval, ask them to send the message again.',
  'channels.credentialPolicy.open.title': 'Open',
  'channels.credentialPolicy.open.summary':
    'Anyone or any group can chat directly',
  'channels.editor.saveError': 'Changes could not be saved',
  'channels.editor.channel': 'Channel',
  'channels.editor.name': 'Name',
  'channels.editor.type': 'Type',
  'channels.editor.nameImmutable': 'The channel name cannot be changed.',
  'channels.editor.nameGenerated':
    'Generated automatically. Change it if you want a more specific name.',
  'channels.editor.typeImmutable': 'The channel type cannot be changed.',
  'channels.editor.selectType': 'Select channel type',
  'channels.editor.authentication': 'Authentication',
  'channels.editor.enterCredentials': 'Enter credentials',
  'channels.editor.continueQr': 'Continue with QR code',
  'channels.editor.qrGuidance':
    'Save this configuration, then continue to QR authentication.',
  'channels.editor.typeSettings': (v) => `${v?.type ?? ''} settings`,
  'channels.editor.section.identity': 'Identity',
  'channels.editor.section.modelWorkspace': 'Model and behavior',
  'channels.editor.section.messagingPolicies': 'Messaging policies',
  'channels.editor.section.routing': 'Routing',
  'channels.editor.section.streaming': 'Streaming',
  'channels.editor.section.memory': 'Memory',
  'channels.editor.section.webhooks': 'Webhooks',
  'channels.editor.secret.keep': 'Keep stored',
  'channels.editor.secret.replace': 'Replace',
  'channels.editor.secret.enter': 'Enter credential',
  'channels.editor.secret.clear': 'Clear stored credential',
  'channels.editor.secret.confirmClear': (v) =>
    `Permanently remove the stored ${v?.label ?? 'credential'}.`,
  'channels.editor.secret.environmentReference': (v) =>
    `Uses environment reference ${v?.reference ?? ''}. Any stored literal secret will be removed when changes are saved.`,
  'channels.editor.environmentSupported':
    'Environment references are supported.',
  'channels.editor.selectField': (v) => `Select ${v?.label ?? ''}`,
  'channels.editor.webhookSecret': (v) => `Webhook secret · ${v?.source ?? ''}`,
  'channels.editor.webhookSecretDescription':
    'Literal webhook secrets are stored separately from configuration.',
  'channels.editor.validation.name':
    'Use a portable name other than “all” (up to 255 bytes).',
  'channels.editor.validation.type': 'Select a manageable channel type.',
  'channels.editor.validation.credentialRequired': (v) =>
    `${v?.label ?? ''} is required. Enter a replacement credential.`,
  'channels.editor.validation.replacementEmpty':
    'Replacement credentials cannot be empty.',
  'channels.editor.validation.confirmClear':
    'Confirm that the stored credential should be cleared.',
  'channels.editor.validation.required': (v) =>
    `${v?.label ?? ''} is required.`,
  'channels.editor.validation.number': (v) =>
    `${v?.label ?? ''} must be a number.`,
  'channels.editor.validation.selectValid': (v) =>
    `Select a valid ${v?.label ?? ''}.`,
  'channels.editor.validation.webhooksObject':
    'Webhooks must be a JSON object.',
  'channels.editor.validation.webhookSource': (v) =>
    `Webhook source ${v?.source ?? ''} is not allowed.`,
  'channels.editor.validation.removeSecretEnv':
    'Remove secretEnv before entering a literal secret.',
  'channels.editor.validation.replaceWebhook':
    'Enter a replacement webhook secret or restore secretEnv.',
  'channels.editor.validation.webhookRequired':
    'Enter a webhook secret, remove this source, or add secretEnv.',
  'channels.editor.field.identity.id': 'Identity ID',
  'channels.editor.field.identity.displayName': 'Display name',
  'channels.editor.field.identity.description': 'Description',
  'channels.editor.field.model': 'Model',
  'channels.editor.field.cwd': 'Workspace',
  'channels.editor.field.senderPolicy': 'Sender policy',
  'channels.editor.field.allowedUsers': 'Allowed users',
  'channels.editor.field.dmPolicy': 'Direct messages',
  'channels.editor.field.groupPolicy': 'Groups',
  'channels.editor.field.sessionScope': 'Session scope',
  'channels.editor.field.dispatchMode': 'Concurrent messages',
  'channels.editor.field.groupHistoryLimit': 'Group history limit',
  'channels.editor.field.blockStreaming': 'Block streaming',
  'channels.editor.field.blockStreamingChunk.minChars':
    'Minimum block characters',
  'channels.editor.field.blockStreamingChunk.maxChars':
    'Maximum block characters',
  'channels.editor.field.blockStreamingCoalesce.idleMs':
    'Streaming idle delay (ms)',
  'channels.editor.field.memoryScope.namespace': 'Memory namespace',
  'channels.editor.field.webhooks': 'Webhooks',
  'channels.editor.field.approvalMode': 'Approval mode',
  'channels.editor.field.instructions': 'Instructions',
  'channels.editor.option.senderPolicy.allowlist': 'Allowlist',
  'channels.editor.option.senderPolicy.pairing': 'Pairing',
  'channels.editor.option.senderPolicy.open': 'Open',
  'channels.editor.option.dmPolicy.open': 'Open',
  'channels.editor.option.dmPolicy.disabled': 'Disabled',
  'channels.editor.option.groupPolicy.disabled': 'Disabled',
  'channels.editor.option.groupPolicy.allowlist': 'Allowlist',
  'channels.editor.option.groupPolicy.open': 'Open',
  'channels.editor.option.sessionScope.user': 'Per user',
  'channels.editor.option.sessionScope.thread': 'Per thread',
  'channels.editor.option.sessionScope.single': 'Single session',
  'channels.editor.option.dispatchMode.steer': 'Steer current turn',
  'channels.editor.option.dispatchMode.followup': 'Queue follow-up',
  'channels.editor.option.dispatchMode.collect': 'Collect messages',
  'channels.auth.title': (v) => `Authenticate ${v?.name ?? ''}`,
  'channels.auth.description': (v) =>
    `Connect this ${v?.type ?? ''} channel without exposing the QR contents to the page.`,
  'channels.auth.qrAlt': (v) =>
    `QR code for ${v?.type ?? ''} channel ${v?.name ?? ''}`,
  'channels.auth.remaining': (v) =>
    `QR session time remaining: ${v?.remaining ?? ''}`,
  'channels.auth.status.starting': 'Starting authentication…',
  'channels.auth.status.requesting': 'Preparing a secure QR code…',
  'channels.auth.status.awaitingScan':
    'Scan the QR code with your channel app.',
  'channels.auth.status.scanned':
    'QR code scanned. Confirm in your channel app.',
  'channels.auth.status.refreshing': 'Refreshing the QR code…',
  'channels.auth.status.ready': 'Authentication is ready to save.',
  'channels.auth.status.committed': 'Authentication saved.',
  'channels.auth.status.cancelled': 'Authentication cancelled.',
  'channels.auth.status.expired':
    'This QR code expired. Start again to get a new one.',
  'channels.auth.status.error': 'Authentication did not complete. Try again.',
  'channels.auth.error.unavailable':
    'This authentication session is unavailable.',
  'channels.auth.error.qrLoad': 'The QR image could not be loaded.',
  'channels.auth.error.statusRefresh':
    'Authentication status could not be refreshed.',
  'channels.auth.error.start': 'Authentication could not be started.',
  'channels.auth.error.save': 'Authentication could not be saved.',
...
const ZH: Messages = {
  ...
  'sidebar.plugins': '插件',
  'sidebar.channels': '频道',
  'sidebar.channelsAttention': '频道需要处理',
  'sidebar.project': '项目',
  ...
  'settings.title': '设置',
  'settings.category.Channels': '频道',
  'settings.channels.title': '频道',
  'settings.channels.description': '管理此工作区的消息频道。',
  'settings.channels.action': '管理频道',
  'channels.title': '频道',
  'channels.summary': (v) =>
    `${v?.workspace ?? ''} · 已配置 ${v?.count ?? 0} 个`,
  'channels.workspace.current': '当前工作区',
  'channels.loading': '正在加载频道',
  'channels.type.unknown': '未知类型',
  'channels.status.stopped': '已停止',
  'channels.status.starting': '正在启动',
  'channels.status.connected': '已连接',
  'channels.status.partial': '部分连接',
  'channels.status.error': '错误',
  'channels.startsWithServe': '随服务启动',
  'channels.unsupported.title': '不支持频道管理',
  'channels.unsupported.description': '请更新到支持频道管理的 Qwen Code 版本。',
  'channels.readOnly.title': '频道管理为只读模式',
  'channels.readOnly.description':
    '请使用 bearer token 重启 Qwen Code，以添加或更改频道。',
  'channels.stale.title': '频道设置已过期',
  'channels.stale.description':
    '工作区快照成功重新加载前，配置更改已禁用。运行时控制仍可使用。',
  'channels.authUnavailable.title': '无法使用二维码认证',
  'channels.authUnavailable.token':
    '请使用 bearer token 重启 Qwen Code，以认证此频道。',
  'channels.authUnavailable.capability':
    '请更新到支持频道认证的 Qwen Code 版本。',
  'channels.loadError.title': '无法加载频道',
  'channels.loadError.retryLabel': '重试加载频道',
  'channels.empty.title': '尚未配置频道',
  'channels.empty.description': '添加频道，将 Qwen Code 连接到消息服务。',
  'channels.yours': '已配置频道',
  'channels.connectAnother': '连接其他平台',
  'channels.viewAllPlatforms': '查看全部平台',
  'channels.details.title': '频道详情',
  'channels.details.status': '状态',
  'channels.details.configuration': '配置',
  'channels.details.runtime': '运行控制',
  'channels.details.closeNamed': (v) => `关闭 ${v?.name ?? ''} 的详情`,
  'channels.details.openNamed': (v) => `查看 ${v?.name ?? ''} 的详情`,
  'channels.pairing.title': '配对管理',
  'channels.pairing.refresh': '刷新配对请求',
  'channels.pairing.tokenRequired': '需要 bearer token 才能查看配对码。',
  'channels.pairing.empty': '暂无待处理的配对请求。',
  'channels.pairing.ageMinutes': (v) => `${v?.count ?? 0} 分钟前`,
  'channels.pairing.allow': '允许',
  'channels.pairing.allowNamed': (v) => `允许 ${v?.name ?? ''}`,
  'channels.pairing.approved': (v) =>
    `已允许 ${v?.name ?? ''}，请让对方重新发送一条消息。`,
  'channels.platformPicker.title': '添加频道',
  'channels.platformPicker.description':
    '选择 Qwen Code 接收消息的平台。同一平台可以连接多次。',
  'channels.platformPicker.search': '搜索平台',
  'channels.platformPicker.empty': '没有匹配的平台',
  'channels.platformPicker.auth.qr': '二维码',
  'channels.platformPicker.auth.credentials': '凭据',
  'channels.platformPicker.auth.qrOrCredentials': '二维码或凭据',
  'channels.configurationReadOnly': '配置为只读模式',
  'channels.runtimeError': '频道运行时错误',
  'channels.actionError': '频道操作失败',
  'channels.error.refreshUnavailable': (v) =>
    `${v?.error ?? ''} 无法刷新频道设置。`,
  'channels.error.refreshFailed': (v) =>
    `${v?.error ?? ''} 刷新失败：${v?.refreshError ?? ''}`,
  'channels.action.back': '返回',
  'channels.action.add': '添加频道',
  'channels.action.cancel': '取消',
  'channels.action.save': '保存',
  'channels.action.close': '关闭',
  'channels.action.delete': '删除频道',
  'channels.action.dismiss': '忽略',
  'channels.action.start': '启动',
  'channels.action.stop': '停止',
  'channels.action.restart': '重启',
  'channels.action.retry': '重试',
  'channels.action.authenticate': '认证',
  'channels.action.startWithServe': '随服务启动',
  'channels.action.editConfiguration': '编辑配置',
  'channels.action.authenticateAgain': '重新认证',
  'channels.action.deleteMenu': '删除频道…',
  'channels.action.saveChanges': '保存更改',
  'channels.action.saveAndContinue': '保存并继续',
  'channels.action.saveAuthentication': '保存认证',
  'channels.action.startNamed': (v) => `启动 ${v?.name ?? ''}`,
  'channels.action.stopNamed': (v) => `停止 ${v?.name ?? ''}`,
  'channels.action.restartNamed': (v) => `重启 ${v?.name ?? ''}`,
  'channels.action.retryNamed': (v) => `重试 ${v?.name ?? ''}`,
  'channels.action.moreNamed': (v) => `${v?.name ?? ''} 的更多操作`,
  'channels.action.editNamed': (v) => `编辑 ${v?.name ?? ''}`,
  'channels.action.deleteNamed': (v) => `删除 ${v?.name ?? ''}`,
  'channels.action.authenticateNamed': (v) => `认证 ${v?.name ?? ''}`,
  'channels.action.startWithServeNamed': (v) =>
    `让 ${v?.name ?? ''} 随服务启动`,
  'channels.delete.title': '删除频道？',
  'channels.delete.description': '此频道将从当前工作区移除。',
  'channels.delete.descriptionNamed': (v) =>
    `${v?.name ?? ''} 将从当前工作区移除。`,
  'channels.editor.title.add': '添加频道',
  'channels.editor.title.connect': (v) => `连接${v?.type ?? ''}`,
  'channels.editor.title.edit': (v) => `编辑 ${v?.name ?? ''}`,
  'channels.editor.description': '配置此工作区连接。已存储的凭据永远不会显示。',
  'channels.editor.currentWorkspace': '当前工作区',
  'channels.dingtalk.title': '配置钉钉',
  'channels.dingtalk.description':
    '手动填写已有钉钉应用的 Client ID 和 Client Secret',
  'channels.dingtalk.clientId': 'Client ID（原 AppKey）',
  'channels.dingtalk.clientIdPlaceholder': '请输入 Client ID',
  'channels.dingtalk.clientSecret': 'Client Secret（原 AppSecret）',
  'channels.dingtalk.clientSecretPlaceholder': '请输入 Client Secret',
  'channels.dingtalk.clientSecretStored': '已保存 Client Secret',
  'channels.dingtalk.docs': '配置文档',
  'channels.dingtalk.accessPolicy': '准入策略',
  'channels.dingtalk.policy.pairing.title': '配对模式',
  'channels.dingtalk.policy.pairing.summary': '需经您允许后，对应会话才能使用',
  'channels.dingtalk.policy.pairing.description':
    '保存后，用户私聊机器人或在群中 @机器人时会收到配对码。只有获准的用户才能使用该频道，群聊中也按用户分别授权。批准后，请用户重新发送消息。',
  'channels.dingtalk.policy.open.title': '开放模式',
  'channels.dingtalk.policy.open.summary': '所有人或群均可直接对话',
  'channels.feishu.title': '配置飞书',
  'channels.feishu.description': '填写已有飞书应用的 App ID 和 App Secret。',
  'channels.feishu.appId': 'App ID',
  'channels.feishu.appIdPlaceholder': '请输入 App ID',
  'channels.feishu.appSecret': 'App Secret',
  'channels.feishu.appSecretPlaceholder': '请输入 App Secret',
  'channels.feishu.appSecretStored': '已保存 App Secret',
  'channels.wecom.title': '配置企业微信',
  'channels.wecom.description':
    '填写已有企业微信智能机器人的 Bot ID 和 Bot Secret。',
  'channels.wecom.botId': 'Bot ID',
  'channels.wecom.botIdPlaceholder': '请输入 Bot ID',
  'channels.wecom.botSecret': 'Bot Secret',
  'channels.wecom.botSecretPlaceholder': '请输入 Bot Secret',
  'channels.wecom.botSecretStored': '已保存 Bot Secret',
  'channels.credentialPolicy.docs': '配置文档',
  'channels.credentialPolicy.accessPolicy': '准入策略',
  'channels.credentialPolicy.pairing.title': '配对模式',
  'channels.credentialPolicy.pairing.summary': '需经您允许后，对应会话才能使用',
  'channels.credentialPolicy.pairing.description':
    '保存后，用户私聊机器人或在群中 @机器人时会收到配对码。只有获准的用户才能使用该频道，群聊中也按用户分别授权。批准后，请用户重新发送消息。',
  'channels.credentialPolicy.open.title': '开放模式',
  'channels.credentialPolicy.open.summary': '所有人或群均可直接对话',
  'channels.editor.saveError': '无法保存更改',
  'channels.editor.channel': '频道',
  'channels.editor.name': '名称',
  'channels.editor.type': '类型',
  'channels.editor.nameImmutable': '频道名称无法更改。',
  'channels.editor.nameGenerated': '名称已自动生成，可按需修改。',
  'channels.editor.typeImmutable': '频道类型无法更改。',
  'channels.editor.selectType': '选择频道类型',
  'channels.editor.authentication': '身份认证',
  'channels.editor.enterCredentials': '输入凭据',
  'channels.editor.continueQr': '继续使用二维码',
  'channels.editor.qrGuidance': '保存此配置，然后继续进行二维码认证。',
  'channels.editor.typeSettings': (v) => `${v?.type ?? ''} 设置`,
  'channels.editor.section.identity': '身份',
  'channels.editor.section.modelWorkspace': '模型和行为',
  'channels.editor.section.messagingPolicies': '消息策略',
  'channels.editor.section.routing': '路由',
  'channels.editor.section.streaming': '流式传输',
  'channels.editor.section.memory': '记忆',
  'channels.editor.section.webhooks': 'Webhook',
  'channels.editor.secret.keep': '保留已存储值',
  'channels.editor.secret.replace': '替换',
  'channels.editor.secret.enter': '输入凭据',
  'channels.editor.secret.clear': '清除已存储凭据',
  'channels.editor.secret.confirmClear': (v) =>
    `永久移除已存储的${v?.label ?? '凭据'}。`,
  'channels.editor.secret.environmentReference': (v) =>
    `使用环境变量引用 ${v?.reference ?? ''}。保存更改时将移除所有已存储的字面量密钥。`,
  'channels.editor.environmentSupported': '支持环境变量引用。',
  'channels.editor.selectField': (v) => `选择${v?.label ?? ''}`,
  'channels.editor.webhookSecret': (v) => `Webhook 密钥 · ${v?.source ?? ''}`,
  'channels.editor.webhookSecretDescription':
    'Webhook 字面量密钥与配置分开存储。',
  'channels.editor.validation.name':
    '请使用“all”以外的可移植名称（最多 255 字节）。',
  'channels.editor.validation.type': '请选择可管理的频道类型。',
  'channels.editor.validation.credentialRequired': (v) =>
    `${v?.label ?? ''}为必填项。请输入替换凭据。`,
  'channels.editor.validation.replacementEmpty': '替换凭据不能为空。',
  'channels.editor.validation.confirmClear': '请确认清除已存储的凭据。',
  'channels.editor.validation.required': (v) => `${v?.label ?? ''}为必填项。`,
  'channels.editor.validation.number': (v) => `${v?.label ?? ''}必须是数字。`,
  'channels.editor.validation.selectValid': (v) =>
    `请选择有效的${v?.label ?? ''}。`,
  'channels.editor.validation.webhooksObject': 'Webhook 必须是 JSON 对象。',
  'channels.editor.validation.webhookSource': (v) =>
    `不允许 Webhook 来源 ${v?.source ?? ''}。`,
  'channels.editor.validation.removeSecretEnv':
    '输入字面量密钥前，请移除 secretEnv。',
  'channels.editor.validation.replaceWebhook':
    '请输入替换 Webhook 密钥，或恢复 secretEnv。',
  'channels.editor.validation.webhookRequired':
    '请输入 Webhook 密钥、移除此来源，或添加 secretEnv。',
  'channels.editor.field.identity.id': '身份 ID',
  'channels.editor.field.identity.displayName': '显示名称',
  'channels.editor.field.identity.description': '描述',
  'channels.editor.field.model': '模型',
  'channels.editor.field.cwd': '工作区',
  'channels.editor.field.senderPolicy': '发送者策略',
  'channels.editor.field.allowedUsers': '允许的用户',
  'channels.editor.field.dmPolicy': '私聊消息',
  'channels.editor.field.groupPolicy': '群组',
  'channels.editor.field.sessionScope': '会话范围',
  'channels.editor.field.dispatchMode': '并发消息',
  'channels.editor.field.groupHistoryLimit': '群组历史记录上限',
  'channels.editor.field.blockStreaming': '分块流式输出',
  'channels.editor.field.blockStreamingChunk.minChars': '分块最少字符数',
  'channels.editor.field.blockStreamingChunk.maxChars': '分块最多字符数',
  'channels.editor.field.blockStreamingCoalesce.idleMs': '流式空闲延迟（毫秒）',
  'channels.editor.field.memoryScope.namespace': '记忆命名空间',
  'channels.editor.field.webhooks': 'Webhook',
  'channels.editor.field.approvalMode': '审批模式',
  'channels.editor.field.instructions': '指令',
  'channels.editor.option.senderPolicy.allowlist': '允许列表',
  'channels.editor.option.senderPolicy.pairing': '配对',
  'channels.editor.option.senderPolicy.open': '开放',
  'channels.editor.option.dmPolicy.open': '开放',
  'channels.editor.option.dmPolicy.disabled': '禁用',
  'channels.editor.option.groupPolicy.disabled': '禁用',
  'channels.editor.option.groupPolicy.allowlist': '允许列表',
  'channels.editor.option.groupPolicy.open': '开放',
  'channels.editor.option.sessionScope.user': '按用户',
  'channels.editor.option.sessionScope.thread': '按线程',
  'channels.editor.option.sessionScope.single': '单一会话',
  'channels.editor.option.dispatchMode.steer': '引导当前轮次',
  'channels.editor.option.dispatchMode.followup': '加入后续队列',
  'channels.editor.option.dispatchMode.collect': '收集消息',
  'channels.auth.title': (v) => `认证 ${v?.name ?? ''}`,
  'channels.auth.description': (v) =>
    `连接此 ${v?.type ?? ''} 频道，页面不会接触二维码内容。`,
  'channels.auth.qrAlt': (v) =>
    `${v?.type ?? ''} 频道 ${v?.name ?? ''} 的二维码`,
  'channels.auth.remaining': (v) => `二维码会话剩余时间：${v?.remaining ?? ''}`,
  'channels.auth.status.starting': '正在开始认证…',
  'channels.auth.status.requesting': '正在准备安全二维码…',
  'channels.auth.status.awaitingScan': '请使用频道应用扫描二维码。',
  'channels.auth.status.scanned': '二维码已扫描。请在频道应用中确认。',
  'channels.auth.status.refreshing': '正在刷新二维码…',
  'channels.auth.status.ready': '认证已可以保存。',
  'channels.auth.status.committed': '认证已保存。',
  'channels.auth.status.cancelled': '认证已取消。',
  'channels.auth.status.expired': '此二维码已过期。请重新开始获取新二维码。',
  'channels.auth.status.error': '认证未完成。请重试。',
  'channels.auth.error.unavailable': '此认证会话不可用。',
  'channels.auth.error.qrLoad': '无法加载二维码图片。',
  'channels.auth.error.statusRefresh': '无法刷新认证状态。',
  'channels.auth.error.start': '无法开始认证。',
  'channels.auth.error.save': '无法保存认证。',
