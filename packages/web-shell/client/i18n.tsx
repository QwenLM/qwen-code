...
const EN: Messages = {
  ...
  'sidebar.addRemoteWorkspace': 'Add remote workspace',
  ...
  'sidebar.addWorkspaceDaemonHint': (vars) =>
    `Folder on ${vars?.address}. Choose a folder below or enter its absolute path.`,
  ...
  'workspaceHost.server': 'Server address',
  'workspaceHost.location': 'Workspace location',
  'workspaceHost.local': 'Local',
  'workspaceHost.localHint': 'Use a folder on this computer.',
  'workspaceHost.remote': 'Remote',
  'workspaceHost.remoteHint': 'Use a folder on a connected server.',
  'workspaceHost.computer': 'Connected computer',
  'workspaceHost.noRemoteConnections':
    'Connect a computer in Daemon Status first.',
  'workspaceHost.token': 'Bearer token',
  'workspaceHost.tokenHint':
    'Leave blank if this tab has already connected to the server.',
  'workspaceHost.next': 'Next: choose folder',
  'workspaceHost.back': 'Change computer',
  ...
  'workspaceHost.folderListError':
    'Could not read folders from this server. Check the path or connection.',
  'workspaceHost.invalidAddress': 'Enter an HTTP or HTTPS server origin.',
  ...
  'workspaceHost.unsupported':
    'This server does not support adding workspaces.',
  'workspaceHost.loadingFolders': 'Loading folders from this server…',
  'workspaceHost.connectionError':
    'Could not load workspace capabilities from this server.',
...
const ZH: Messages = {
  ...
  'sidebar.addRemoteWorkspace': '添加远程工作区',
  ...
  'sidebar.addWorkspaceDaemonHint': (vars) =>
    `${vars?.address} 上的目录。请从下方选择，或输入绝对路径。`,
  ...
  'workspaceHost.server': '服务器地址',
  'workspaceHost.location': '工作区位置',
  'workspaceHost.local': '本地',
  'workspaceHost.localHint': '使用这台电脑上的文件夹。',
  'workspaceHost.remote': '远程',
  'workspaceHost.remoteHint': '使用已连接服务器上的文件夹。',
  'workspaceHost.computer': '已连接的计算机',
  'workspaceHost.noRemoteConnections': '请先在 Daemon 状态中连接一台计算机。',
  'workspaceHost.token': 'Bearer token',
  'workspaceHost.tokenHint': '如果当前标签页已连接过该服务器，可以留空。',
  'workspaceHost.next': '下一步：选择目录',
  'workspaceHost.back': '更换计算机',
  'workspaceHost.parent': '上一级',
  'workspaceHost.addFolder': '添加此文件夹',
  'workspaceHost.noFolders': '此目录下没有子目录。',
  'workspaceHost.folderListError': '无法读取服务器目录，请检查路径或连接状态。',
  'workspaceHost.invalidAddress': '请输入 HTTP 或 HTTPS 服务器地址。',
  'workspaceHost.navigationUnavailable':
    '浏览器存储不可用，无法安全继续添加远程目录。',
  'workspaceHost.unsupported': '此服务器不支持添加工作区。',
  'workspaceHost.loadingFolders': '正在从此服务器加载目录…',
  'workspaceHost.connectionError': '无法从此服务器加载工作区能力。',
