...
const EN: Messages = {
  ...
  'queue.edit': 'Edit',
  'queue.insert': 'Insert',
  'queue.immediateInsert': 'Insert now',
  'queue.cleared': 'Queue cleared.',
  'queue.deleteTip': 'Remove from queue',
  'queue.editTip': 'Remove from queue and edit again',
  'queue.insertTip':
    'Insert into the same turn on the next model call without stopping the current response.',
  'queue.immediateInsertTip':
    'Stop the current model response, insert this message into the same turn, and continue.',
  ...
  'queue.midTurnSubmitting': 'Inserting into the current turn...',
  'queue.midTurnQueued': 'Waiting for the model...',
  'queue.midTurnQueuedTip':
    'The message will take effect on the next model call.',
  'queue.immediateInserting': 'Inserting now...',
  'queue.immediateWaiting': 'Waiting for immediate effect...',
  ...
  'queue.immediateInsertFailed': 'Failed to insert queued message immediately',
...
const ZH: Messages = {
  ...
  'queue.edit': '编辑',
  'queue.insert': '插入',
  'queue.immediateInsert': '立即插入',
  'queue.cleared': '队列已清空。',
  'queue.deleteTip': '移出队列',
  'queue.editTip': '移出队列并将内容放回输入框',
  'queue.insertTip': '不中断当前输出，在同一回合的下一次模型调用时生效。',
  'queue.immediateInsertTip':
    '打断当前模型输出，在同一回合立即插入并继续生成。',
  'queue.insertCommandDisabled': '命令无法插入当前回合。',
  'queue.submitting': '提交中...',
  'queue.serverQueued': '排队中...',
  'queue.midTurnSubmitting': '正在插入当前回合...',
  'queue.midTurnQueued': '等待模型接收...',
  'queue.midTurnQueuedTip': '将在下一次模型调用时生效。',
  'queue.immediateInserting': '正在立即插入...',
  'queue.immediateWaiting': '等待立即生效...',
  'queue.editing': '编辑中...',
  'queue.removing': '处理中...',
  ...
  'queue.immediateInsertFailed': '立即插入排队消息失败',
