...
const EN: Messages = {
  ...
  'branchPicker.commitPlaceholder': 'Commit message',
  ...
  'branchPicker.commitSuccess': (v) => `Committed ${v?.sha ?? ''}`,
  'gitCommit.title': 'Commit',
  'gitCommit.changes': (v) => `Changes (${v?.count ?? 0} files)`,
  'gitCommit.loading': 'Loading changes…',
  'gitCommit.noChanges': 'No changes to commit',
  'gitCommit.messagePlaceholder': 'Commit message (⌘Enter to commit)',
  'gitCommit.generating': 'Generating commit message…',
  'gitCommit.commit': 'Commit',
  'gitCommit.commitAndPush': 'Commit and Push',
  'gitCommit.createPr': 'Create PR',
  ...
  'gitCommit.prBasePlaceholder': 'Base branch',
  'gitCommit.prSubmit': 'Create',
  'gitCommit.prCreated': (v) => `PR #${v?.number ?? ''} created`,
...
const ZH: Messages = {
  ...
  'branchPicker.commitPlaceholder': '提交信息',
  ...
  'branchPicker.commitSuccess': (v) => `已提交 ${v?.sha ?? ''}`,
  'gitCommit.title': '提交',
  'gitCommit.changes': (v) => `变更（${v?.count ?? 0} 个文件）`,
  'gitCommit.loading': '加载变更中…',
  'gitCommit.noChanges': '无变更可提交',
  'gitCommit.messagePlaceholder': '提交信息（⌘Enter 提交）',
  'gitCommit.generating': '正在生成提交信息…',
  'gitCommit.commit': '提交',
  'gitCommit.commitAndPush': '提交并推送',
  'gitCommit.createPr': '创建 PR',
  'gitCommit.prTitlePlaceholder': 'Pull Request 标题',
  'gitCommit.prBodyPlaceholder': '描述（可选）',
  'gitCommit.prEdit': '编辑',
  'gitCommit.prPreview': '预览',
  'gitCommit.prBasePlaceholder': '目标分支',
  'gitCommit.prSubmit': '创建',
  'gitCommit.prCreated': (v) => `PR #${v?.number ?? ''} 已创建`,
