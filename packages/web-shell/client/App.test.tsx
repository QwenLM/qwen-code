  ...
  return {
    ...
    testState: {
      ...
      workspaceEventSignals: {
        ...
        extensionsVersion: 0,
        skillsVersion: 0,
        lastSkillMutation: undefined as
          | {
              id: string;
              kind: 'skill_toggle';
          ...
          | undefined,
        lastSkillMutationsByCwd: undefined as
          | Record<
              string,
              Array<{
                id: string;
...
function emitSkillMutation(
  ...
  const previousByCwd = testState.workspaceEventSignals.lastSkillMutationsByCwd;
  const existing = cwd ? (previousByCwd?.[cwd] ?? []) : [];
...
beforeEach(() => {
  ...
  testState.workspaceEventSignals = {
    ...
    lastSkillMutationsByCwd: undefined,
  };
...
describe('App session callbacks', () => {
  ...
  it('retries a cancelled partial Skill refresh after returning to the session', async () => {
    mockConnection.commands = [
      {
        name: 'web-search',
        description: 'Search the web',
    ...
    testState.workspaceEventSignals = {
      ...
      skillsVersion: 1,
      lastSkillMutation: {
        id: 'partial-web-search-mid-switch',
        kind: 'skill_toggle',
        skills: [{ name: 'web-search', enabled: false }],
        activation: 'partial',
        sessionsRefreshed: 0,
  ...
  it('keeps the workspace Skill fallback when an unrelated commands update races the refresh', async () => {
    mockConnection.commands = [
      {
        name: 'web-search',
        description: 'Search the web',
    ...
    testState.workspaceEventSignals = {
      ...
      skillsVersion: 1,
      lastSkillMutation: {
        id: 'partial-web-search-establish-race',
        kind: 'skill_toggle',
        skills: [{ name: 'web-search', enabled: false }],
        activation: 'partial',
        sessionsRefreshed: 0,
  ...
  it('keeps the workspace Skill fallback after an unrelated commands update', async () => {
    mockConnection.commands = [
      {
        name: 'web-search',
        description: 'Search the web',
    ...
    testState.workspaceEventSignals = {
      ...
      skillsVersion: 1,
      lastSkillMutation: {
        id: 'partial-web-search-clear-race',
        kind: 'skill_toggle',
        skills: [{ name: 'web-search', enabled: false }],
        activation: 'partial',
        sessionsRefreshed: 0,
  ...
  it('retries a cancelled partial Skill refresh after reconnecting', async () => {
    mockConnection.commands = [
      {
        name: 'web-search',
        description: 'Search the web',
    ...
    testState.workspaceEventSignals = {
      ...
      skillsVersion: 1,
      lastSkillMutation: {
        id: 'partial-web-search-reconnect',
        kind: 'skill_toggle',
        skills: [{ name: 'web-search', enabled: false }],
        activation: 'partial',
        sessionsRefreshed: 0,
  ...
  it('restores an earlier workspace Skill fallback after an intervening toggle', async () => {
    mockConnection.commands = [
      skillCommandFixture('web-search', 'Search the web'),
    ];
    mockConnection.skills = ['web-search'];
  ...
  it('keeps a batched partial Skill toggle when a later applied mutation arrives', async () => {
    mockConnection.commands = [
      skillCommandFixture('web-search', 'Search the web'),
    ];
    mockConnection.skills = ['web-search'];
    ...
    const partialDisable = {
      id: 'partial-web-search-batch',
      kind: 'skill_toggle' as const,
      skills: [{ name: 'web-search', enabled: false }],
    ...
    testState.workspaceEventSignals = {
      ...testState.workspaceEventSignals,
      skillsVersion: testState.workspaceEventSignals.skillsVersion + 2,
      lastSkillMutation: appliedOther,
      lastSkillMutationsByCwd: {
        '/tmp/project': [partialDisable, appliedOther],
      },
    };
    rerender();
    await flush();
