...
const EN = {
  ...
  'session.sourceLabel': 'Conversation source',
  'session.source.vscode': 'VS Code',
  'session.source.default': 'Terminal / Web',
...
const ZH: Record<ChromeStringKey, string> = {
  ...
  'session.sourceLabel': '会话来源',
  'session.source.vscode': 'VS Code',
  'session.source.default': '终端 / Web',
