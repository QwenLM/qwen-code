...
| 方面 | 旧版 | 新版 | 变化 |
|------|------|------|------|
| **目录** | `packages/chrome-extension` | `packages/mcp-chrome-integration` | 新目录 |
...
// ~/.qwen/mcp-servers.json
{
  "chrome-browser": {
    "command": "node",
    "args": [
      "/path/to/qwen-code/packages/chrome-extension/native-host/dist/host.js"
    ]
  }
}
```
