...
# Linux
vim ~/.config/google-chrome/NativeMessagingHosts/com.qwen.mcp_chrome_bridge.json

# Windows
notepad %APPDATA%\Google\Chrome\NativeMessagingHosts\com.qwen.mcp_chrome_bridge.json
```
...
[NativeMessaging] Connecting to native host: com.qwen.mcp_chrome_bridge
