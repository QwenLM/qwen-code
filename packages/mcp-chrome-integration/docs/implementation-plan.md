...
**现有架构** (`packages/chrome-extension`):
```
...
cp -r packages/chrome-extension/src packages/mcp-chrome-integration/app/chrome-extension/
cp -r packages/chrome-extension/public packages/mcp-chrome-integration/app/chrome-extension/
cp -r packages/chrome-extension/config packages/mcp-chrome-integration/app/chrome-extension/
cp -r packages/chrome-extension/scripts packages/mcp-chrome-integration/app/chrome-extension/
cp packages/chrome-extension/package.json packages/mcp-chrome-integration/app/chrome-extension/
cp packages/chrome-extension/tsconfig.json packages/mcp-chrome-integration/app/chrome-extension/
```
...
const HOST_NAME = 'com.qwen.mcp_chrome_bridge';  // 需要与 native-server 注册名一致
...
```typescript
// Extension → Native Host
const nativePort = chrome.runtime.connectNative('com.qwen.mcp_chrome_bridge');
...
1. 📝 编写文档:
   ...
   - `docs/customization-guide.md` - 定制指南
...
- React Extension: `/Users/yiliang/projects/temp/qwen-code/packages/chrome-extension`
- Native Host: `/Users/yiliang/projects/temp/qwen-code/packages/chrome-extension/native-host`
...
- `/Users/yiliang/projects/temp/qwen-code/packages/chrome-extension/src/background/service-worker.js`
