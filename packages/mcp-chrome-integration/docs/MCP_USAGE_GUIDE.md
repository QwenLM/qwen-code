...
# 在主目录添加
cd ~
qwen mcp add chrome node /Users/yiliang/projects/temp/qwen-code/packages/mcp-chrome-integration/app/native-server/dist/index.js
...
```bash
# 检查文件是否存在
ls -la /Users/yiliang/projects/temp/qwen-code/packages/mcp-chrome-integration/app/native-server/dist/index.js

# 检查是否可执行
node /Users/yiliang/projects/temp/qwen-code/packages/mcp-chrome-integration/app/native-server/dist/index.js --help 2>&1 | head -5
```
...
- **需要 Extension**:
  ...
  - Extension 需要先完成通信层适配（参考 `docs/IMPLEMENTATION_SUMMARY.md`）

---

## 📚 相关文档

- **调试指南**: `/Users/yiliang/projects/temp/qwen-code/packages/mcp-chrome-integration/docs/DEBUG_GUIDE.md`
- **实施总结**: `/Users/yiliang/projects/temp/qwen-code/packages/mcp-chrome-integration/docs/IMPLEMENTATION_SUMMARY.md`
- **依赖安装报告**: `/Users/yiliang/projects/temp/qwen-code/packages/mcp-chrome-integration/docs/DEPENDENCY_INSTALLATION_REPORT.md`
...
- 服务器路径: `app/native-server/dist/index.js`
- 状态: Disconnected（正常）
