...
- Full text previews allocate up to the existing download ceiling in the browser. Unsupported encodings and file changes surface as errors. The byte-download path remains available independently of text rendering.
