...
- 在“设置 > 连接”中添加一台远程计算机，再通过普通“添加工作区”的“目录来源”选择该计算机，浏览并注册一个目录，确认新 workspace 在该 daemon 上成为当前 workspace。
