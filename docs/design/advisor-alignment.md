...
- Put explicit consultation and evidence-reconciliation guidance in the native tool description. It reaches both executor and eligible subagent tool surfaces, including discovery. Preserve permission checks; advice never grants approval. There are no mandatory checkpoints or automatic commits.
