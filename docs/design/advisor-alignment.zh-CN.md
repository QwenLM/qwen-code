...
实际运行证据和所有失败记录在 [PR 验收讨论](https://github.com/QwenLM/qwen-code/pull/12688#issuecomment-5831380864)。完成上述有界验收或记录明确外部阻塞前，PR 保持 draft。Mock 通过或单个模型响应成功都不能证明与 Claude 完全等价。
