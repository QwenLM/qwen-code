...
`v0.24.1...v0.24.2` 之间与工具/权限/注册表相关的改动只有 8 个文件、6 个 PR，其中**只有 #10410 改变了默认行为**；其余是散文与门控：#12142（teammate 指引按 team 开关门控 + 体积预算测试）、#12271（`zoom_image` 提示按可达性发送）、#12318（`/context` 归因 + 文档）、#12034（extension 条件规则 + 常驻上下文告警上限）、#12346（纯测试）。
