...
| 方案                                                   | 预计收益     | 复杂度 | 说明                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------------------------------------------ | ------------ | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **(A)** 预热 ACP：daemon boot 后立刻 `ensureChannel()` | **0.3-0.5s** | 低     | `ensureChannel()` 不需要 session 上下文，可在 `app.listen()` 后立即调用。将 ACP spawn 与 HTTP 监听并行化。注意：只并行化了 spawn 阶段，session init 仍需串行等待                                                                                                                                                                                                           |
