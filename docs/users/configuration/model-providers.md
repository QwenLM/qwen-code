...
| **Gemini** (`@google/genai`)                  | `thinkingConfig: { includeThoughts: true, thinkingLevel }` (Gemini 3) / `thinkingConfig: { includeThoughts: true, thinkingBudget }` (Gemini 2.5) | Gemini 3 sends `thinkingLevel` with `low` → `LOW`, `medium` → `MEDIUM` (clamped to `HIGH` on Pro), `high`/`xhigh`/`max` → `HIGH` (one-time clamp warning). Gemini 2.5 sends `thinkingBudget` buckets (`low` → 2048, `medium` → 8192, `high` → 16384, `xhigh`/`max` → 32768 Pro / 24576 Flash); when effort is unset, neither knob is sent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
