...
| `Ctrl+V` / `Option+V` (Windows: `Alt+V`)              | Paste clipboard content. Images become attachments. On Windows, files copied in Explorer paste as image attachments or their paths.                                                                                                                                                                                       |
