...
A larger subsystem is audited as coherent sub-paths, one bounded run each. Lowering the effort is never the remedy for a cap refusal — the priced cost is a function of line counts alone.
