...
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ----------------------------------- | ---------------- |
| `low`    | 3-6 directed inline angles over the diff plus a gap sweep and an under-floor re-pass — no subagents, no build/test, no project rules                        | 10 (unverified)     | None                                | Never            |
