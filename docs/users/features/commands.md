...
| → `memory`      | Show current process memory diagnostics                                                                                                                                                                                                                                                         | `/doctor memory [--json]`        |
| → `cpu-profile` | Record a CPU profile for Chrome DevTools analysis                                                                                                                                                                                                                                               | `/doctor cpu-profile`            |
| → `rollback`    | Roll back a standalone update to the previous version                                                                                                                                                                                                                                           | `/doctor rollback`               |
