...
| → `--compaction`  | Set the model used for chat compression                                               | `/model --compaction <model-id>`, `/model --compaction clear`                                             |
| → `--image`       | Set an image-only model for the built-in image generation tool                        | `/model --image <model-id>`                                                                               |
