...
- **Prefix-caching models invert the trade.** For models whose discount depends on a stable prefix, keeping the prefix identical is worth more than making it small.
