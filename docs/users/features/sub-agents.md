...
| Tools         | Configured declaration set                                     | Keeps the parent-derived declaration set; `fork_tools` or `fork_profile` can independently narrow execution without changing that declaration |
