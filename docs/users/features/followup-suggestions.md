...
After Qwen Code finishes responding, a suggestion appears as dimmed text in the input area. For example, after fixing a bug, you might see:
...
Suggestions go through 12 quality filters to ensure they are useful:

- Must be 2-12 words (CJK: 2-30 characters)
- Cannot be evaluative ("looks good", "thanks")
- Cannot use AI voice ("Let me...", "I'll...")
- Cannot be multiple sentences
- Cannot contain formatting (markdown, newlines)
