...
This feature works end-to-end in the CLI. In Web Shell, the hook and UI plumbing are available, but host applications must trigger suggestion generation and wire the followup state for suggestions to appear.
