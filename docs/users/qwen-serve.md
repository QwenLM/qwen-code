...
| `--pairing-qr`                          | `false`            | Print the token-bearing pairing QR even when stdout is captured (not an interactive terminal) and the bearer is an operator-supplied (stable) token, which is withheld by default to keep stable credentials out of collected logs. Can also be set via the `serve.pairingQr` setting, honored from user, system, and system-defaults scopes only; the flag wins when passed, and `--no-pairing-qr` vetoes the setting for that run.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
