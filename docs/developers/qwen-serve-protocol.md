...
| `GET /workspaces/:workspace/runtime/extensions`                    | trusted target: `200` runtime catalog snapshot; it is initialized/current-epoch only when the runtime is already live, and the read does not start or prepare a cold runtime; untrusted target: `403 untrusted_workspace` |
...
| `workspace_extensions_config_runtime` | authoritative workspace runtime lifecycle and the split Extension config/runtime routes are wired; each target route still enforces that workspace's trust and runtime state.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
