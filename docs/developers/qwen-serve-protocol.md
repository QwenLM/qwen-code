...
| `webbridge`                         | the daemon exposes the direct WebBridge browser-control surface. `/status` and `/command` require `QWEN_WEBBRIDGE_TOKEN`; daemon-bearer clients use `/webbridge/status` for read-only extension readiness.                                                                                                                                                                                                                                                                                                      |
