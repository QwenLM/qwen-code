...
| Tag                                 | Advertised when …                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `agent_collaboration_v1`            | the daemon opted into persistent workspace Agent collaboration via `experimental.agentCollaboration` (or `QWEN_CODE_ENABLE_AGENT_COLLABORATION=1`), resolved once at startup. Present means `/workspaces/:workspace/agent/*` is mounted; absent means it was never registered, so a client must drop the collaboration entry point rather than render it and let the calls 404. Changing the setting requires a daemon restart. Distinct from the unconditional `workspace_agents` tag, which is subagent-definition CRUD.                                                                                                                                                                                                                                                                  |
