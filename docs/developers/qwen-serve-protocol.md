...
| `GET /workspaces/:workspace/runtime/extensions`                    | `200` current-epoch live runtime catalog                                    |
...
| `workspace_extensions_config_runtime` | every active workspace supports authoritative runtime lifecycle and the split Extension config/runtime routes used by Extension management.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `workspace_extension_mentions`        | every active workspace supports workspace-qualified composer Extension discovery and same-runtime `@ext:` resolution.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
