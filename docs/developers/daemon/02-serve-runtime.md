...
| `packages/core`: `loadSettings`, `getCurrentMemoryFilename`, `Config`, `WorkspaceContext`       | Direct embedders, tests                   |
...
| `settings.json` | `context.fileName`                                                                                         | `getCurrentMemoryFilename` override for the bridge.                                                        |
