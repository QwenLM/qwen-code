...
- `packages/web-shell/client/adapters/` — Web Shell rendering of ACP-shaped messages relayed via `postMessage`.
...
- `packages/web-shell/client/adapters/` (Web Shell ACP-message adapter)
