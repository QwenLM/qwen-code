...
| `@qwen-code/qwen-code-core` — `ApprovalMode`, `TrustGateError`, `getCurrentMemoryFilename` | `packages/channels/base/` (planned, F4)        |
...
| `contextFilename`                             | from `settings.json`'s `context.fileName`          | Overrides `getCurrentMemoryFilename`.                                                                                                                        |
