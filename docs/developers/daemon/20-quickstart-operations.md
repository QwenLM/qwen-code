...
| `--memory-budget-mb <n>`                | integer >= `1024`              | 50% of cgroup/host memory                        | Observation only                         | Total memory budget for the daemon process tree, capped at resolved host memory. Reported under `limits.memory`; does not size any child.                                                                                                                                                                             |
