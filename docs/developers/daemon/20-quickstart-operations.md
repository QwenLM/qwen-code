...
| `--child-heap-mode <mode>`              | `off \| observe`               | `observe`                                        | Observation only                         | Reports the modeled partition under `limits.memory.childHeap`; applies nothing and refuses nothing.                                                                                                                                                                                                                   |
