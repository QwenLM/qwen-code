...
| Stateless generation           | [`POST /session/:id/generate`](./qwen-serve-protocol.md#post-sessionidgenerate) · [`POST /workspace/generate`](./qwen-serve-protocol.md#post-workspacegenerate)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `session_generation` (live-session-owner), `workspace_generation` (legacy-primary)                                                                                                                                             | `DaemonClient.generateSessionContent`, `DaemonSessionClient.generateContent`, `DaemonClient.generateWorkspaceContent`                                                              |
